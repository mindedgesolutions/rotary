                        ...
                        <tr>
                            <td width="650" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-bottom:5px">
                                    <tr>
                                        <td align="left" colspan="3">
                                       	  <h1 style="padding:0; margin:0">View 
										  Data Login</h1>
                                        </td>
								...
								<div class="auto-style1">
									<span class="auto-style2">Contact RILM 
									Office or Webmaster for Username &amp; Password.<br>
									</span>
    ...
    <tr>
        <td>
            <p style="padding:15px 15px 0 15px; margin:0">
                <form id="DTLogin" name="DTLogin" action="detailviewlogin.php" method="post" onsubmit="return validation()">
