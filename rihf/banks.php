...
$query2=mysql_query("SELECT * from rihf_content where text_heading='PACEMAKER BANKS' limit 0,1");
	...
	<?php       
	 ...
	 ?>
        ...
        <td align="left" valign="top" class="text"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" valign="top"><span class="heading1">PACEMAKER</span> <span class="heading2">BANKS</span><br /><br /><table width="697" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?php echo $rec2['text_dscription'];?><br /></td>
  </tr>
  <tr>
    <td><a href="donate.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image14','','images/save_3a.png',1)"><img src="images/save_3.png" name="Image14" width="239" height="48" border="0" id="Image14" /></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="success_stories.php?type=Pacemaker-Banks" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image16','','images/successa.png',1)"><img src="images/success.png" name="Image16" width="171" height="48" border="0" id="Image16" /></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="login.php?msg=3" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','images/refer_a.png',1)"><img src="images/refer.png" name="Image15" width="144" height="48" border="0" id="Image15" /></a></td>
  </tr>
  <tr>
  <td>&nbsp;</td>
  </tr>
