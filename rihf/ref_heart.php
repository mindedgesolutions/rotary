...
<div style="width:210px; height:61px; top: 237px; left: 11px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; line-height:22px; text-align:justify;"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image11','','images/ref_e_2.jpg',1)"><img src="images/ref_e_1.jpg" name="Image11" width="211" height="58" border="0" id="Image11" /></a></div>
  ...
  <table width="159" height="99" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="138"><a href="my_home.php?ht=home" style="text-decoration:none;"><span style="color:#FFFFFF;">My Home</span></a></td>
    </tr>
    <tr>
      <td><img src="images/pointer2.jpg" width="10" height="10" /></td>
      <td><a href="my_home.php?ht=account" style="text-decoration:none;"><span style="color:#FFFFFF;">Account Settings</span></a></td>
    </tr>
    <tr>
      <td><img src="images/pointer2.jpg" width="10" height="10" /></td>
  ...
  <form action="ins_heart_case.php" method="post" enctype="multipart/form-data" name="frm1">
  <table width="694" height="452" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="3"> <span class="style6">Save a little heart </span></td>
  </tr>
  <tr>
