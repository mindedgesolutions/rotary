            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                  <p>
                   <h3>Asha Kiran NGO Partners and their Operational Districts. <br />
                   <br>
                   </h3>
                  </p>
                  <div style="text-align:justify; line-height:18px">
                    <div class="box-body table-responsive">
                      <center><img src="images/CHILD-DEVELOPMENT.jpg" style="border:thin #000 solid;" alt="" title="Asha Kiran NGO Partners with their Operational Districts"></center>
                    </div>
                   </div>
                </div>
              </div>
