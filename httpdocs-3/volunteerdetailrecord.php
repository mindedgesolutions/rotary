...
$dist= $_GET["district"];
$query = "SELECT id,concat(firstname,' ',ifnull(midname,''),' ',ifnull(lastname,'')) as name,rotaryDistrict,rotaryClubname,city,date_format(submitted,'%d-%m-%Y') as regisdt FROM `registration` WHERE rotaryDistrict='".$dist."' and deleted=0 ORDER BY rotaryClubname asc;";

$query = $query."SELECT count(id) as totalvolunteer FROM `registration` WHERE rotaryDistrict='".$dist."' and deleted=0 group by rotaryDistrict;";
	$arr=null;
	$cnt=-1;
	$arrcnt=-1;
                               ...
                               <table width="100%" cellpadding="5" cellspacing="0" align="center" border="1" bordercolor="#CCCCCC" style="text-align: center; font-family:arial; font-size:12px; background:#ffffff; border-collapse:collapse" class="link">
                                  	...
                                  	<tr>
                                    	<td width="9%" style="background:#f5f5f5; font-weight:bold; text-align:center; width:12%">Id</td>
                                   	  ...
                                   	  <td style="background:#f5f5f5; font-weight:bold; text-align:center; width:11%">District</td>
                                   	  <td style="background:#f5f5f5; font-weight:bold; text-align:center; width:19%">Club</td>
									  <td style="background:#f5f5f5; font-weight:bold; text-align:center; width:14%">City</td>
										<td width="17%" style="background:#f5f5f5; font-weight:bold; text-align:center; width:22%">Date</td>
                               	 </tr>
                                ...
                                <?php foreach($arr["volunteerInfo"] as $record)  { ?>
									<tr>
                                    	...
                                    	<td style="font-family:'Courier New', Courier, monospace; font-size:14px; font-weight:bold;  background:#fffff1; width: 11%;">
											<?php echo $record["rotaryDistrict"]; ?>
                                        </td>
                                    	<td style="font-weight:bold; width: 19%;">
											<?php echo $record["rotaryClubname"]; ?>
                                        </td>
                                ...
                                <?php } ?>
									...
									<tr>
                                    	...
                                    	<td style="font-family:'Courier New', Courier, monospace; font-size:14px; font-weight:bold; background:#66FF99"><?php echo $arr["volunteerCnt"][0]["totalvolunteer"]; ?>
                                        </td>
                                    	<td style="font-family:'Courier New', Courier, monospace; font-size:14px; font-weight:bold;  background:#fffff1; width: 11%;">&nbsp;
										</td>
                                    	<td style="font-family:'Courier New', Courier, monospace; font-size:14px; font-weight:bold; background:#f1f9ff; width: 19%;">&nbsp;
										</td>
										<td style="font-family:'Courier New', Courier, monospace; font-size:14px; font-weight:bold;  background:#fffff1; width: 14%;">&nbsp;
										</td>
                                    	<td style="font-family:'Courier New', Courier, monospace; font-size:14px; font-weight:bold; background:#f1f9ff">&nbsp;
										</td>
                                	</tr>
