...
<html lang="en">
  <head>
    ...
    <title>Adult Literacy | <?php include('include/title.php'); ?></title>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <ul class="as-breadcrumb">
                  ...
                  <li><a href="teacher_gal.php#">Adult Literacy</a></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-12">
                ...
                <div class="as-gallery">
                  <ul class="row gallery">
                    ...
                    <?php
                    $query_getLearn = mysql_query("select * from image_master where gallery_type='Adult Literacy' and status='activate' order by SLN desc");
