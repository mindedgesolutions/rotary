...
foreach($quarter as $value){
 $sql = "Insert into quarter_2 values(NULL,'$child_id','$exam','$value','$date_of')";	
 echo $sql;
 $result = mysql_query($sql);
...
<!-- Main content -->
 ...
 <div class="box-body">   
     <?php echo $msg; ?>      
     <form action="quarter_2.php" method="post" enctype="multipart/form-data"> 
          <fieldset>
         ...
         <table width="100%" border="1">
          <tr>
            ...
            <td width="16%" align="center" colspan="3"><strong>2nd Quarter</strong></td>
          </tr>
          <?php
          ...
          <tr>
            ...
            <td colspan="3"><input type="text" class="form-control" name="quarter[]" value=""/></td>
            <input type="hidden" class="form-control"  name="exam" value="2"/>
          ...
          <tr>
            <td>N</td>
            <td>Number of Working days in Month</td>
            <td><input type="text" class="form-control" name="working_days_1" value=""/></td>
            <td><input type="text" class="form-control" name="working_days_2" value=""/></td>
            <td><input type="text" class="form-control" name="working_days_3" value=""/></td>
          </tr>
          <tr>
            <td>O</td>
            <td>Attendance of Student in that month</td>
            <td><input type="text" class="form-control" name="attendance_of_student_1" value=""/></td>
            <td><input type="text" class="form-control" name="attendance_of_student_2" value=""/></td>
            <td><input type="text" class="form-control" name="attendance_of_student_3" value=""/></td>
          </tr>
          <tr>
            <td>P</td>
            <td>Attendance of Teacher in that month</td>
            <td><input type="text" class="form-control" name="attendance_of_teacher_1" value=""/></td>
            <td><input type="text" class="form-control" name="attendance_of_teacher_2" value=""/></td>
            <td><input type="text" class="form-control" name="attendance_of_teacher_3" value=""/></td>
          </tr>
        </table>
