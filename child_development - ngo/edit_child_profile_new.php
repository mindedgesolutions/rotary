...
<!-- Main content -->
 ...
 <form role="form" id="image_upload" action="edit_child_profile_new.php?action=edit" method="post" enctype="multipart/form-data">
 <div class="box-body">
     <?php echo $msg; ?>
     <!--<fieldset>-->
      ...
      <?php if ($child_photo!=''){ ?>
        <img src="../upload/<?php echo $child_photo; ?>" height="120" width="120" alt="No Image" id="oldimg">
      <?php } ?>
      </div>
