    ...
    <tr>
        <td>
            <p style="padding:15px 15px 0 15px; margin:0"><span style="color:#FF0000; font-size:14px; font-weight:bold"><?php echo $msg;?></span>
				...
				<form name="frmpdf" id="frmpdf" method="post" action="pagetopdf.php"  style="line-height:18px; font-family:Arial, Helvetica, sans-serif; font-size:12px; text-align:justify; margin:10px 0 0 0">
<input type="hidden" name="hdnpdfrefappno" id="hdnpdfrefappno" value="<?php echo $arr[0]["refappno"]?>"/>
...
<script type="text/javascript">
	...
	var pars = 	'district='+$("#txtDistrict").val()+'&club='+$("#txtClub").val()+'&email='+$("#txtemail").val()+'&pwd='+$("#txtpwd").val()+'&refappno='+$('#txtrefno').val();
//	alert(pars)
			$.ajax({                                      
			  url: 'loginvalidationforpdf.php',                     
			  data: pars,
			  type:"post",
				dataType: 'json',
