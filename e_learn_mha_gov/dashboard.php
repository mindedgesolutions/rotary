...
<div id="divID" class="content-section">
					...
					<div class="contents">
						...
						<section class="boxpadding">
							<div class="col-md-12">								
								...
								<label style="font-size:15px;"><u><a href="e_learn_mh_gov.php"><font style="color:#357ebd;">ADD SCHOOL</font></a></u></label><br/> 																
							</div>
							<div class="clearfix"></div>
						</section>
					</div>
...
<?php 
$sql = "select survey_id,userid,name,village,email,school_name,ph_no,final_submission
		from tbl_school_survey_maharashtra_gov where userid='$userid'";
//order by a.district;		
...
<script type="text/javascript">document.getElementById('divID').style.display = 'none';</script>
			...
			<div class="form-group" style="padding-left:25px; padding-right:25px;">
                          <table border="0" cellspacing="0" cellpadding="0"  width="100%" class="tbl">
                                 <thead>
									...
									<td width="30%"><p style="font-size: 15px;"><b>School Name</b></p></td>
									<td width="5%"><p style="font-size: 15px;"><b>Action</b></p></td>
                                  </thead>                                                                               
		<?php
		...
		?>	
		<td><p><a href='http://rotaryteach.org/e_learn_mha_gov/view_user_e_learn_mh_gov_1_2.php?id=<?php echo $survey_id; ?>'><font style="color:#357ebd;"><b><u>View</u></b></font></a></p></td>   		
		...
		{
		?>
		<td><p><a href='http://rotaryteach.org/e_learn_mha_gov/edit_e_learn_mh_gov_1_2.php?id=<?php echo $survey_id; ?>'><font style="color:#357ebd;"><b><u>Edit</u></b></font></a></p></td>   		
		<?php
		}
		?>
		</tr>
