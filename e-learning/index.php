...
function showTable(){
  ...
  if (schoolNo=='' || projector==''){
    ...
    $.ajax({
      ...
      url: 'show_table.php',
      type: 'post',
      data: 'schoolNo=' + schoolNo + '&prno=' + prno + '&folderno=' + folderno + '&projector=' + projector,
      success: function(f){
          ...
          <div class="col-md-10" style="margin: 50px 0;">
            ...
            <table>
              <tr>
                ...
                <td width="35%"><input type="text" name="schoolNo" id="schoolNo" value="" onkeyup="numbersOnly(this)" class="form-control" /></td>
                <td width="50%">&nbsp;</td>
              </tr>
              ...
              <tr>
                ...
                <td width="50%"><input type="button" name="schoolBtn" id="schoolBtn" value="OK" class="btn btn-primary" onclick="showTable()" style="margin: 0 0 0 15px;width: 80px;" /></td>
              </tr>
            </table>
