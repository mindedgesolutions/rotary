    ...
    <div class="tab-content">
      <div class="tab-pane active" id="tab_1">
          ...
          <div class="body bg-gray">
            <p><?php echo $msg; ?></p>
            <form action="untaggeddonor.php" name="tagged" method="post" enctype="multipart/form-data">
        <table width="100%" border="0">
          <tr>
            ...
            <?php 
		    $sql=mysql_query("Select DISTINCT donar_district from tbl_donar_master_no_email where tagged = 'no' ORDER BY donar_district");
		   ...
		   ?>
			...
			$club = $_POST['club'];
			$sql = "Select * from tbl_donar_master_no_email where donar_district = '$district' AND donar_club = '$club' AND tagged = 'no' ORDER BY first_name ";
				...
				<td>
				   <div style="width:100%; height:253px; overflow:auto;">
                     ...
                     <tr>
						...
						<td width="14%"><p>Fill Details for Tagging</p></td>
					  ...
					  if(isset($_POST['submit'])){
					   $district = $_POST['district'];
					   $club = $_POST['club'];  
					   $sql = "Select * from tbl_donar_master_no_email where donar_district = '$district' AND donar_club = '$club'  AND tagged = 'no'";  
					   //echo $sql;
					   $result = mysql_query($sql);	  
                      ...
                      <tr>
                        ...
                        <td><a href="http://rotaryteach.org/child_development/other/donor.php">Fill Details for Tagging</a></td>
			  ...
			  <tr>
				<td>
				   <div style="width:100%; height:253px; overflow:auto;">
                     ...
                     <tr>
						<td width="14%"><p>Donor Name</p></td>
						<td width="14%"><p><td>Fill Details for Tagging</p></td>
                        <!--<td width="14%"><p>Resend Link</p></td>-->
					  </tr>
                      <?php
					  if(isset($_POST['submit'])){
