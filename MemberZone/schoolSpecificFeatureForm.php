			  ...
			  type:"post",
				...
				success: function(data)         
				{
					...
					for(var i=0; i<SDParr.length; i++) {
						$('.SDP_'+SDParr[i]).show()
						if(SDParr[i]==1) {
						$("input[name=isneedrepair][value='No']").attr('checked', 'checked');
						opendiv(data[0]["isneedrepair"],'repairneed');
						$("input[name=isneedpaint][value='No']").attr('checked', 'checked');
...
<td colspan="3"><table width="100%" border="1" bordercolor="#cccccc" cellspacing="0" cellpadding="5" align="center" style="text-align:left; border-collapse:collapse">
  ...
  <tr id="waterfacility">
    <td colspan="3"><strong>If, ‘no’ , please provide brief detailsof the existing facility  :</strong><br />
        <table width="100%" border="1" bordercolor="#cccccc" cellspacing="0" cellpadding="5" align="center" style="text-align:left; border-collapse:collapse; margin-top:7px">
          
          <tr>
            <td width="52%" ><strong>A descriptive account of the existing facility</strong></td>
            <td width="2%"><strong>:</strong></td>
            <td width="46%"><input type="text" name="txtwaterfacility" id="txtwaterfacility" style="background:#ffffee; border: 1px solid #cccccc; line-height:22px" /></td>
            </tr>
          <tr>
...
<td><input type="text" id="txtboystoiletcost" name="txtboystoiletcost"  onkeypress="inputNumber(event,this.value,true);" class="toiletcost"   style="background:#ffffee; border: 1px solid #cccccc; line-height:22px" />&nbsp;<input type="file" name="imgboystoiletcost" id="imgboystoiletcost"/><input type="hidden" name="hdnimgboystoiletcost" id="hdnimgboystoiletcost"/>
</td>
</tr>
<tr>
...
<td><input type="text" id="txtteachertoiletcost" name="txtteachertoiletcost" onkeypress="inputNumber(event,this.value,true);" class="toiletcost"  style="background:#ffffee; border: 1px solid #cccccc; line-height:22px" />&nbsp;<input type="file" name="imgteachtoiletcost" id="imgteachtoiletcost"/><input type="hidden" name="hdnimgteachtoiletcost" id="hdnimgteachtoiletcost"/></td>
</tr>
<tr>
<td><strong>Total cost</strong></td>
<td colspan="3"><input type="text" id="txttotaltoiletcost" name="txttotaltoiletcost"  onkeypress="inputNumber(event,this.value,true);"  style="background:#ffffee; border: 1px solid #cccccc; line-height:22px"  onblur="estimatetotal('toiletcost','txttotaltoiletcost')" /></td>
</tr>
...
<td colspan="3"><table width="100%" border="1" bordercolor="#cccccc" cellspacing="0" cellpadding="5" align="center" style="text-align:left; border-collapse:collapse">
  <tr>
    ...
    <td width="2%"><strong>:</strong></td>
    <td width="43%"><input type="radio" name="isgovtprovideuniform" value="No"/>No</td><!-- checked="checked"-->
  </tr>
  <tr>
