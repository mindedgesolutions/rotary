...
<div class="wrapper">
	...
	if($flg=="y")	{ ?>
		<form class="form-horizontal" name="frm" id="frm" action="ins_school_survey_frm1.php" method="POST" enctype="multipart/form-data" >
		<?php 
		...
		?>
                                                <tr>												
                                                    ...
                                                    <td class="col-md-8">
													<input class="form-control" type="text" id="txtSurveyId" name="txtSurveyId" maxlength="10" value="<?php echo $survey_id; ?>" readonly />
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<input class="form-control" type="text" id="txtPhoneNo" name="txtPhoneNo" maxlength="10" value="<?php echo $ph_no; ?>" required onkeypress="return IsNumeric1(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input type="text" id="txtPersonName" name="txtPersonName" class="form-control" value="<?php echo $name; ?>" >   
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Postal Address :</td>
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtAddress" name="txtAddress" value="<?php echo $Address; ?>" >   
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Email id :</td>
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtEmailID" name="txtEmailID" onblur="checkEmail(this.value)" value="<?php echo $email; ?>" >  
                                                    </td>
                                                </tr>
											<?php
												}
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                        <div class="form-group has-error">
                                                            <button type="button" class="btn btn-primary" name="submit" onClick="window.location = 'http://rotaryteach.org/Comprehensive_School_Survey/cssform2.php?suid=<?php echo $survey_id; ?>'">Next</button>
                                                        </div>
                                                    </td>
                                                </tr>
	...
	<form class="form-horizontal" name="frm" id="frm" action="ins_school_survey_frm1.php" method="POST" enctype="multipart/form-data" >			
                                                <tr>												
                                                    <td class="col-md-4">Select your identity :</td>
                                                    <td class="col-md-8">
													<input class="form-control" type="text" id="txtSurveyId" name="txtSurveyId" maxlength="10" value="o" readonly />
												...
												<tr>
                                                    <td class="col-md-4">Phone Number :</td>
                                                    <td class="col-md-8">
														<input class="form-control" type="text" id="txtPhoneNo" name="txtPhoneNo" maxlength="10" required onkeypress="return IsNumeric1(event);" ondrop="return false;" onpaste="return false;" />
														<span id="error1" style="color: Red; display: none">* Input digits (0 - 9)</span>
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Full Name:</td>
                                                    <td class="col-md-8">
                                                     <input type="text" id="txtPersonName" name="txtPersonName" class="form-control" required>   
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Postal Address :</td>
												...
												<tr>
                                                    <td class="col-md-4">Email id :</td>
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtEmailID" name="txtEmailID" onblur="checkEmail(this.value)" required>  
                                                    </td>
                                                </tr>
