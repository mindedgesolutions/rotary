...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  -->
    ...
    <legend>Your Asha kiran Child</legend>
	  ...
	  <?php 
		//echo $create_by; 
		$sqlExam="Select * from tbl_admin where username='$create_by'";
		$q_result=mysql_query($sqlExam);
		while($rowExam=mysql_fetch_array($q_result)){
			extract($rowExam);
		}
		//echo $examtype;
	  ?>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="11%" height="30"><a href="quarterly_report.php?pid=<?php echo $child_id; ?>"><input type="submit" name="submit1" class="btn btn-success btn-sm" value="View Report"></a></td>
            <?php } ?>
			<?php if($examtype=='Monthly') { ?>
            <td width="11%" height="30"><a href="monthly_report.php?pid=<?php echo $child_id; ?>"><input type="submit" name="submit1" class="btn btn-success btn-sm" value="View Report"></a></td>
            <?php } ?>
			<td width="33%" height="30" colspan="3">&nbsp;</td>
          </tr>
       </table>
      </fieldset>
    ...
    <br>
      ...
      <a href="tagged_by.php">
      <?php }else{ ?>
      <a href="tagged_by_honor.php">
      <?php } ?>
