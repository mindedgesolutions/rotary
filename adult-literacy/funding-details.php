...
$getDet = mysql_fetch_array(mysql_query("select rotary_fund, international_fund, global_grant, external_support, corporate_support, other_funding, description from project_adult_literacy where project_no='".base64_decode($_REQUEST['prno'])."'"));
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-10" style="margin: 50px 0;">
            ...
            <div class="header-text"><h3>Funding Details : Adult Literacy</h3></div>
            ...
            <table>
              ...
              <tr>
                ...
                <td style="line-height: 18px;width: 40%;height: 60px;line-height: 60px;font-size: 90%;text-align: center;">
                  <input type="text" name="rotary_fund" id="rotary_fund" value="<?= $getDet['rotary_fund'] ?>" class="form-control" style="width: 90%;" onkeyup="numbersOnly(this)" onchange="showTotal()" />
                </td>
              ...
              <tr>
                ...
                <td style="line-height: 18px;width: 40%;height: 50px;line-height: 50px;font-size: 90%;text-align: center;">
                  <input type="text" name="international_fund" id="international_fund" value="<?= $getDet['international_fund'] ?>" class="form-control" style="width: 90%;" onkeyup="numbersOnly(this)" onchange="showTotal()" />
                </td>
              ...
              <tr>
                ...
                <td style="line-height: 18px;width: 40%;height: 50px;line-height: 50px;font-size: 90%;text-align: center;">
                  <input type="text" name="global_grant" id="global_grant" value="<?= $getDet['global_grant'] ?>" class="form-control" style="width: 90%;" onkeyup="numbersOnly(this)" onchange="showTotal()" />
                </td>
              ...
              <tr>
                ...
                <td style="line-height: 18px;width: 40%;height: 50px;line-height: 50px;font-size: 90%;text-align: center;">
                  <input type="text" name="external_support" id="external_support" value="<?= $getDet['external_support'] ?>" class="form-control" style="width: 90%;" onkeyup="numbersOnly(this)" onchange="showTotal()" />
                </td>
              ...
              <tr>
                ...
                <td style="line-height: 18px;width: 40%;height: 50px;line-height: 50px;font-size: 90%;text-align: center;">
                  <input type="text" name="corporate_support" id="corporate_support" value="<?= $getDet['corporate_support'] ?>" class="form-control" style="width: 90%;" onkeyup="numbersOnly(this)" onchange="showTotal()" />
                </td>
              ...
              <tr>
                ...
                <td style="line-height: 18px;width: 40%;height: 50px;line-height: 50px;font-size: 90%;text-align: center;">
                  <input type="text" name="other_fund" id="other_fund" value="<?= $getDet['other_funding'] ?>" class="form-control" style="width: 90%;" onkeyup="numbersOnly(this)" onchange="showTotal()" />
                </td>
              ...
              <tr>
                ...
                <td style="line-height: 18px;width: 40%;height: 50px;line-height: 50px;font-size: 90%;text-align: center;">
                  <input type="text" name="total" id="total" value="<?= $totalAmt ?>" class="form-control" style="width: 90%;" onkeyup="numbersOnly(this)" />
                </td>
            ...
            <table style="margin: 30px 0 0 0;">
              ...
              <tr>
                <td width="100%">
                  <textarea style="width: 100%;height: 120px;resize: none;float: left;" class="form-control" name="comments" id="comments" onkeyup="wordCount(this)"><?= urldecode($getDet['description']) ?></textarea>
                </td>
              </tr>
            </table>
            ...
            if (isset($_REQUEST['submitBtn'])){
              ...
              $update = "update project_adult_literacy set rotary_fund='".$_REQUEST['rotary_fund']."', international_fund='".$_REQUEST['international_fund']."', global_grant='".$_REQUEST['global_grant']."', external_support='".$_REQUEST['external_support']."', corporate_support='".$_REQUEST['corporate_support']."', other_funding='".$_REQUEST['other_fund']."', description='".urlencode($_REQUEST['comments'])."' where project_no='".base64_decode($_REQUEST['prno'])."'";
