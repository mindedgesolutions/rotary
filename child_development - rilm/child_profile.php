...
//$sql = "SELECT * FROM  tbl_child_profile_card where create_by='abhas' and centerid='1' ORDER BY name_partner_ngo ASC";
//$sql = "SELECT * FROM  tbl_child_profile_card where create_by in ('abhas','Mrinal')  and centerid='1' ORDER BY name_partner_ngo ASC";
$sql = "SELECT * FROM  tbl_child_profile_card ORDER BY name_partner_ngo ASC";
...
$del = $_GET['del'];	
// delete country
$sql = "delete from  tbl_child_profile_card where child_id = '$del'";	
