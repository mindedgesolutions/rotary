...
//$emailarr = array('sanjuchou27@gmail.com','sanjuchou2010@yahoo.co.in');
...
$my_path = $_SERVER['DOCUMENT_ROOT']."/AdminPanel/uploadattach/";
$my_name = "ADMIN";
$my_mail = "info@rotaryteach.org";
$my_replyto = "info@rotaryteach.org";
            ...
            <tr>
                ...
                <td style="background:#FFFFFF" valign="top">
                    ...
                    <p class="text">
                        ...
                        <tr><td align="right"><div align="right"><a href="Panel.php" class="login">Back to Admin Panel</a><a href="logout.php" class="login">Logout</a></div></td></tr>
                        	<tr>
                        		<td>
                                    ...
                                    <table width="40%" border="0" cellspacing="0" cellpadding="0" style="text-align:left; margin-bottom:10px">
                                        <tr>
                                            <td width="8%"><img src="volunteer.jpg" /></td>
                                    ...
                                    <form name="frm" id="frm" action="sentmail.php" method="post" enctype="multipart/form-data" onsubmit="return validation();">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:left; margin-bottom:15px;">
                                        	...
                                        	<tr>
                                                <td><img src="msg.jpg" /></td>
                                                <td><strong>Sublect</strong></td>
                                                <td><strong>:</strong></td>
                                                <td>
                                        	...
                                        	<tr height="15"><td colspan="4"></td></tr>
                                            <tr>
                                                <td valign="top"><img src="msg.jpg" /></td>
