...
$getDet = mysql_fetch_array(mysql_query("select * from tbl_donar_master where donar_email='".$_SESSION['email']."'"));

$ch_count = mysql_fetch_array(mysql_query("select count(child_id) as childCount from tbl_child_selected_tagging where donar_id='".$getDet['donar_id']."'"));
?>
  ...
  <aside class="right-side">
		...
		<div class="box-body table-responsive">     
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td width="80%"><p>: <?= $getDet['donar_email'] ?></p></td>
				</tr>
				<tr>
					<td width="20%"><p>District</p></td>
					<td width="80%"><p>: <?= $getDet['donar_district']; ?></p></td>
				</tr>
				<tr>
					<td width="20%"><p>Club</p></td>
					<td width="80%"><p>: <?= strtoupper($getDet['donar_club']); ?></p></td>
				</tr>
				<tr>
	...
	<hr>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      $query_childDet = mysql_query("select * from tbl_child_selected_tagging where donar_id='".$getDet['donar_id']."'");
      while ($childDet = mysql_fetch_array($query_childDet)){

        $createDate = mysql_fetch_array(mysql_query("select child_photo, create_date, name_partner_ngo from tbl_child_profile_card where child_id='".$childDet['child_id']."'"));
      ?>
      <tr>
        ...
        <td><p><?= ucwords($childDet['child_name']) ?></p></td>
