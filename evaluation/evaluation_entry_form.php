...
<header>
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="col-xs-4">
        <h3 style="color:#ffffff; text-align:center;">Self Evaluation Form for <?php echo $head; ?></h3>
      </div>
      <div class="col-xs-4" >
...
<?php  
	...
	$sqledit = "select * from tbl_eva_exam_header where district='$district' and exam_no='$stype' and evalu_type_no='$eval_type_no'";
	...
	if ($count > 0) {
		...
		window.location.href="edit_evaluation_entry_form.php?smbt=99&stype='.$stype.'&eval_type_no='.$eval_type_no.'";
		</script>
		';
		}
		if ($smbt == '-1'){
		...
		<script>
		alert("You have previously entered data in this Evaluation section. Your selections will be visible on the form.");
		window.location.href="edit_evaluation_entry_form.php?smbt=-1&stype='.$stype.'&eval_type_no='.$eval_type_no.'";
		</script>
		';
		}
...
<form class="form-horizontal" name="frm" id="frm" onsubmit="return GetTextValue();" action="frmsave.php" method="get" enctype="multipart/form-data" >
