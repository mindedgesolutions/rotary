...
<html lang="en">
  <head>
    ...
    <title>Happy School | <?php include('include/title.php'); ?></title>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <ul class="as-breadcrumb">
                  ...
                  <li><a href="teacher_gal.php#">Happy School</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="as-main-section">
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-12">
				<div class="as-fancytitle"><h2>Happy School</h2></div>
                ...
                <div class="as-gallery">
                  <ul class="row gallery">
                    ...
                    <?php
                    $query_getLearn = mysql_query("select * from image_master where gallery_type='Happy School' and status='activate' order by SLN desc");
                    while ($getLearn = mysql_fetch_array($query_getLearn)){
                    ?>
                    
                    <li class="col-md-3">
                      <figure>
                        <div class="thumb-div-1">
                          <img src="backend-cms/<?= $getLearn['image'] ?>" alt="<?= urldecode($getLearn['image_name']) ?>" style="height: 250px;width: 100%;" />
                        </div>
                        <figcaption>
                          <div class="as-galleryinfo">
                            <h3><?= strtoupper(urldecode($getLearn['image_header'])) ?></h3>
                          </div>
                          <div class="as-gallery-icon">
                            <a href="backend-cms/<?= $getLearn['image'] ?>" data-rel="prettyPhoto[gallery1]" title="" class="as-bgcolorhover">
