...
//--========================For Pagination==========================--//
$query = "select * from project_master where status='complete' order by id desc";
...
if ($lastPage!='1'){
    ...
    if($pn!=1){
        $previous = $pn - 1;
        $paginationDisplay .= '&nbsp; <a href="'.$_SERVER['PHP_SELF'].'?pn='.$previous.'" style="color: #000000;text-decoration: none;margin-right: 20px;">Previous</a>';
    }
