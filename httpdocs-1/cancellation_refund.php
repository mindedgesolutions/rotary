...
<html lang="en">
  <head>
    ...
    <title>Cancellation & Refund Policy | <?php include('include/title.php'); ?></title>
...
We will not entertain any cancellation request or retreat request after 24 hours of payment. If cancellation is done then we will refund the entire amount via same source within 07 to 10 working days.
<br>
<br>
If the donor has paid twice for one transaction, the one transaction amount will be refunded via same source within 07 to 10 working days.
<br>
<br>
<strong>Contact Us</strong>
If you have any questions about these Terms, please <a href="contact.php" target="_blank" style="text-decoration:underline;">contact us.</a>
