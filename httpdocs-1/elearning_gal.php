...
<html lang="en">
  <head>
    ...
    <title>E-Learning | <?php include('include/title.php'); ?></title>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <ul class="as-breadcrumb">
                  ...
                  <li><a href="teacher_gal.php#">E-learning</a></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-12">
                ...
                <div class="as-gallery">
                  <ul class="row gallery">
                    ...
                    <?php
                    $query_getLearn = mysql_query("select * from image_master where gallery_type='E-Learning' and status='activate' order by SLN desc");
