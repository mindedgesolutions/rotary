...
<table border="0" cellpadding="5" cellspacing="0" width="70%" align="center" style="text-align:left; color:#666666; font-family:Arial, Helvetica, sans-serif; font-size:12px; background:#f5f5f5; box-shadow:0 0 1px #999999; border:1px solid #FFFFFF">
    <tr>
        <td>
            <p style="padding:15px 15px 0 15px; margin:0"><span style="color:#FF0000; font-size:14px; font-weight:bold"></span>
                ...
                <tr>
                    <td><a href="grantApplication.php">Introductory Form</a><br />
						<a href="schoolInfoForm.php">School Information Form</a><br />
						<a href="schoolSpecificFeatureForm.php">Selection Criteria & Cost Estimation Form</a><br />
