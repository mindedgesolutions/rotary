...
$sql = "Select * from RARFormdata where id = '$unique_id'";	
...
if($data['id'] == $unique_id){
	...
	header('location:toolkit_form_update.php');
 }
}
}
else{
	$mesg = '<center><font color="#FF0000">Check your Email for Proper Unique ID.</font></center>';
	}
                    ...
                    <table width="880" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top:15px">
                        <tr>
                            <td width="100%" valign="top" >
                                ...
                                <?php echo $mesg; ?>
                                <br />
                                <form action="RPRFormUpdate.php" name="update" method="post">
                                <input type="text" name="unique_id" placeholder="Unique ID" value="" style="width:400px;" required="required"/> 
