      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-10" style="margin: 50px 0;">
            ...
            <div class="header-text"><h3>Teacher Support : Nation Builder Award</h3></div>

            <table>
              <tr>
                <td width="25%" style="color: #757575;text-align: right;padding: 0 15px 0 0;">Date of award distribution : </td>
                <td width="25%"><input type="text" name="distDate" id="distDate" value="" readonly="readonly" class="form-control" /></td>
                <td width="50%">&nbsp;</td>
              </tr>
              ...
              <tr>
                ...
                <td width="25%"><input type="text" name="schoolNo" id="schoolNo" value="" onkeyup="numbersOnly(this)" class="form-control" /></td>
