...
<tr>
  <td><a href="districttracker.php" style="text-decoration:none">
    <div class="vio"> <img src="images/view-progress-tracker.png" alt="" height="60" style="margin-bottom:8px" border="0" />
      <p style="padding:7px 0 0 0; margin:0; border-top:1px dashed #e0e0e0"> Complete Progress Tracker</p>
    </div>
  </a></td>
  <td></td>
  <td><a href="nationalcommitee.php" style="text-decoration:none">
    <div class="blue1"> <img src="images/view-n-c-member.png" alt="" height="60" style="margin-bottom:8px" border="0" />
      <p style="padding:7px 0 0 0; margin:0; border-top:1px dashed #e0e0e0">National Committee Members</p>
    </div>
  </a></td>
  <td></td>
  <td><a href="DGlist.php" style="text-decoration:none">
    <div class="pink"> <img src="images/view-dg.png" alt="" height="60" style="margin-bottom:8px" border="0" />
      <p style="padding:7px 0 0 0; margin:0; border-top:1px dashed #e0e0e0">District Governors</p>
    </div>
  </a></td>
  <td></td>
  <td><a href="DLCC.php" style="text-decoration:none">
    <div class="grey"> <img src="images/volunteer.png" alt="" height="60" style="margin-bottom:8px" border="0" />
...
<tr>
    <td colspan="3">
      <a href="iw.htm" style="text-decoration:none">
        <div class="vio"><img src="images/view-dg.png" alt="" height="60" style="margin-bottom:8px" border="0" />
          <p style="padding:7px 0 0 0; margin:0; border-top:1px dashed #e0e0e0">
            Inner Wheel Chairs</p>
          </div>
        </a>    
          </td>
	<td width="30"></td>
	<td colspan="3">
	  <a href="#" style="text-decoration:none">
	    <div class="pink">
	      ...
	      <p style="padding:7px 0 0 0; margin:0; border-top:1px dashed #e0e0e0">Rotaract DRR</p>
	      </div>
	    </a>    
	    </td>
	</tr>
...
<tr>
  ...
  <td></td>
  <td colspan="3">
    <a href="RPRdetail.php" style="text-decoration:none; letter-spacing:0px">
      <div class="orr">Toolkit Order Details</div>
      </a>
    </td>
</tr>
</table>
