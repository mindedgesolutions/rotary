...
$result = mysql_query($sql);
 while($row = mysql_fetch_array($result)){
  ...
  $sqlchild="select count(*) as totchild from tbl_child_selected_tagging where donar_id='$donar_idN'";
...
<!-- Main content -->
 ...
 <form role="form" action="master_data_conf_child.php" method="post" enctype="multipart/form-data">
 <div class="box-body">
     <?php echo $msg; ?>
     <fieldset>
	  <legend>Donor Child Record</legend>
	<?php if ($totchild>0)  { ?>	
          ...
          <div class="row">
             <div class="col-sm-6">
                         <label>Child No</label>
                          <input type="number" class="form-control" name="txtChild" id="txtChild" value="<?php echo $totchild; ?>"/>
              </div>
      ...
      <input type="submit" name="submit" class="btn btn-primary" value="Submit" onclick="return myFunction();" />
      </div>
      </div>
            </div>
        </div>
