...
$sql3 = "SELECT * FROM  tbl_child_selected_tagging WHERE donor_email = '$user_email'";
  ...
  <aside class="right-side">
    ...
    <!-- Main content -->
	 ...
	 <h5 class="page-header">
        Name : <?php echo ucfirst($_SESSION['username']); ?><br>
        District : <?php echo ucfirst($donar_district); ?><br>
        Club : <?php echo ucfirst($donar_club); ?></br>
        Total Children Tagged : <?php echo $count; ?>
     </h5>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  ?>
        ...
        <td><a href="view_child_progress.php?pid=<?php echo $child_id; ?>"><button class="btn btn-success btn-sm">View</button></a></td>
      </tr>
      <?php
		}
	}// row_country end
