...
$dist= $_GET["district"];
$query = "SELECT name,Noofbook,club,date_format(submitdt,'%d-%m-%Y') as collectiondt FROM `book` WHERE district='".$dist."' ORDER BY club asc;";

$query = $query."SELECT sum(NoOfbook) as noofbookcllected FROM `book` WHERE district='".$dist."' group by district;";

	$arr=null;
	$cnt=-1;
	$arrcnt=-1;
	$assoc=array("DTInfo","bookCnt");
                        ...
                        <tr>
                            <td width="650" valign="top">
                               ...
                               <table width="100%" cellpadding="5" cellspacing="0" align="center" border="1" bordercolor="#CCCCCC" style="text-align: center; font-family:arial; font-size:12px; background:#ffffff; border-collapse:collapse" class="link">
                                  	...
                                  	<tr>
                                    	<td width="12%" style="background:#f5f5f5; font-weight:bold; text-align:center; width:12%">Club</td>
                                    	<td width="22%" style="background:#f5f5f5; font-weight:bold; text-align:center; width:22%">No. of<br />Books Collected</td>
                                    	<td width="22%" style="background:#f5f5f5; font-weight:bold; text-align:center; width:22%">Data Uploaded by</td>
                                    	<td width="22%" style="background:#f5f5f5; font-weight:bold; text-align:center; width:22%">Collection Date</td>
                                ...
                                <?php foreach($arr["DTInfo"] as $record)  { ?>
									<tr>
                                    	...
                                    	<td style="font-family:'Courier New', Courier, monospace; font-size:14px; font-weight:bold; background:#f1f9ff"><?php echo $record["Noofbook"]; ?>
                                        </td>
                                    	<td style="font-weight:bold">
											<?php echo $record["name"]; ?>
                                        </td>
                                    	<td style="font-family:'Courier New', Courier, monospace; font-size:14px; font-weight:bold; background:#f1f9ff">
											<?php echo $record["collectiondt"]; ?>
                                        </td>
                                	</tr>
                                <?php } ?>
									...
									<tr>
                                    	...
                                    	<td style="font-family:'Courier New', Courier, monospace; font-size:14px; font-weight:bold; background:#66FF99"><?php echo $arr["bookCnt"][0]["noofbookcllected"]; ?>
                                        </td>
