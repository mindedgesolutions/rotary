      ...
      <tr style="text-align: center;">
        ...
        <td style="padding: 0 0 0 10px;">
          <p>
            ...
            $donorName = mysql_fetch_array(mysql_query("select first_name, last_name from tbl_donar_master where donar_id='".$getDet['shared_to_donor']."'"));

            echo $donorName['first_name'].' '.$donorName['last_name'];
            ?> 
          </p>
        </td>
