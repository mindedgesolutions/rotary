...
return false;
	...
	var pars ='district='+val;
	$.ajax({                                      
      url: 'http://rotaryteach.org/AdminPanel/Administratorlist.php',                     
      data: pars,
	  type:"post",
		dataType: 'json',
                        		...
                        		<td>
                                    ...
                                    <table width="40%" border="0" cellspacing="0" cellpadding="0" style="text-align:left; margin-bottom:10px">
                                        <tr>
                                            ...
                                            <td width="66%">
                                           <select id="chodistrict" name="chodistrict" class="button"  style="width:50%; cursor:pointer; color:#333333; font-weight:bold; padding:7px 0 7px 4px">
											<option value="">Select</option>
											<option value="All">All</option>
											</select>
                                            </td>
                                        </tr><!--onchange="dispLieracyTeam(this.value)"-->
									...
									<td width="66%">
									<select id="chodesign" name="chodesign" class="button" style="width:100%; cursor:pointer; color:#333333; font-weight:bold; padding:7px 0 7px 4px">
									<option value="">Select</option>
									...
									<td align="center"  colspan="4"><input type="button" value="Search" id="btnsearch" onclick="dispLieracyTeam();" class="login"/></td>
									</tr>
...
var str = "";
$.ajax({                                      
      url: 'http://rotaryteach.org/AdminPanel/districtlistfromInfo.php',                     
      data: '',
	  type:"post",
		dataType: 'json',
		success: function(data)         
