...
//alert(171)
	...
	str = str+"<tr><td width='10%' style='border-bottom:1px solid #cccccc; font-style:italic; font-size:11px; color:#999999'><input type='checkbox'  name='select_all' id='select_all' onclick='ckeckUncheck()' title='Select All'/>Select All</td><td style='border-bottom:1px solid #cccccc'><em><strong>District</strong></em></td><td style='border-bottom:1px solid #cccccc'><em><strong>Name</strong></em></td><td style='border-bottom:1px solid #cccccc'><em><strong>Email</strong></em></td></tr>";
	var pars ='';
	$.ajax({                                      
      url: 'dlcclist.php',                     
      data: pars,
		...
		success: function(data)         
      	{
			...
			if(data.length>0)
			{
				...
				{
				if(data[i]["email"]!='') {
				str = str+"<tr><td style='border-bottom:1px solid #cccccc'><input type='checkbox'  class='chkemail' name='chkemails[]' value='"+data[i]["email"]+"'></td><td style='border-bottom:1px solid #cccccc'>"+data[i]["district"]+"</td><td style='border-bottom:1px solid #cccccc'>"+data[i]["name"]+"</td><td style='border-bottom:1px solid #cccccc'>"+data[i]["email"]+"</td></tr>";
				}
				}
			}
			else
