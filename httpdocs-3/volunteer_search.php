...
$sql = "Select * from registration where type = '$type' and firstname = '$fname' and lastname = '$lname'";
//echo $sql;
$result = mysqli_query($link,$sql);
while($data = mysqli_fetch_array($result,MYSQLI_ASSOC)){
	$id = $data['id'];
	if($data['firstname'] == $fname && $data['lastname'] == $lname && $type == $type){
	 header('location:update.php?isp='.$id);	
	}
 }	
}
?>
                    ...
                    <table width="880" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top:15px">
                        <tr>
                            <td width="100%" valign="top" >
                                <h1 align="left">Do you want to continue as a volunteer ?</h1>
                                ...
                                <p></p>
                                <form action="volunteer_search.php" name="form" method="post">
                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                  ...
                                  <tr>
                                    <td>
                                    <input type="text" name="fname" value="" placeholder="Your First Name" required="required"/>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>
                                    <input type="text" name="lname" value="" placeholder="Your Last Name" required="required"/>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td align="center">
