...
'$profile_createdby','$create_date','$status','Unapproved','$type','no','0','0','0','0','0','0','0','0','0')";
//echo $sql;
$ans = mysql_query($sql);
if($ans){
 ...
 <div class="box-body">
     ...
     <fieldset>
      ...
      <div class="form-group">
       ...
       <input type="text" class="form-control" placeholder="00/00/0000" name="child_dob" required/>
      </div> 
      <div class="form-group">
      ...
      <div class="form-group">
       ...
       <br>
       A. The Child is between age group 7 to 14 yrs&nbsp;&nbsp;<input type="radio" class="form-control" name="studied" value="A"/><br>
       B. Child who has never been to School&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" class="form-control" name="studied" value="B"/><br>
       C. Child who is not attending school fro more than 45days without information to school&nbsp;&nbsp;
       <input type="radio" class="form-control" name="studied" value="C"/><br>
       D. Child who is a laggard (e.g The Child's age is 12 years but can read text of only Class II & III etc)&nbsp;&nbsp;<input type="radio" class="form-control" name="studied" value="D"/>
      </div> 
      <!--<div class="form-group">
       <label>Address</label>
      ...
      <div class="form-group">
       ...
       <input type="text" class="form-control" placeholder="City /Block.." name="city" required/>
      </div>  
      <div class="form-group">
       <label>State</label>
      ...
      <div class="form-group">
       ...
       <input type="text" class="form-control" placeholder="Partner NGO.." name="ngo_partner" value="<?php echo $_SESSION['username']; ?>"required/>
      </div>
      <div class="form-group">
       <label>NGO Organisation</label>
       <input type="text" class="form-control" placeholder="Partner NGO.." name="ngo_partner" value="<?php echo $_SESSION['ngo_name']; ?>"required/>
      </div>
