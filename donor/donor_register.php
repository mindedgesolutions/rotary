...
if ($_POST['txtMemberFirstName']!='' || $_POST['txtMemberMobile']!='' || $_POST['txtMemberEmail']!='' || $_POST['district']!='' || $_POST['club']!='')
{
	$cnt=1;
	...
	$sql="select * from tbl_donar_master where first_name !=''";

	if ($_POST['txtMemberFirstName']!='')
	{
		 $sql=$sql . "  and first_name like '%$first_name%' or last_name like '%$first_name%'";
	}
	if ($_POST['txtMemberMobile']!='')
	{
		 $sql=$sql . " and donar_contact='$donar_contact'";
	}
	if ($_POST['txtMemberEmail']!='')
	{
		 $sql=$sql . " and donar_email='$donar_email'";
	}
	if($_POST['district']!='' && $_POST['club']!='')
	{
	...
	if($_POST['club']!="")
	{
		$sql=$sql . " and donar_club like '%$club%'";
	}
...
<section class="content" style="padding-left:20px; padding-right:20px;">
 ...
 <div class="box-body">
	...
	<div class="form-group">
		...
		<div class="row" id="advanced_search" <?php if ($_REQUEST['district']!='' || $_REQUEST['club']!=''){ ?>style="display: block;"<?php }else{ ?>style="display:none;"<?php } ?>>
			<div class="col-sm-4">
				...
				<div class="col-sm-4">
					<label>Club</label>
					<input type="text" class="form-control" name="club" id="club" value="<?php if ($_REQUEST['club']!=''){echo $_REQUEST['club'];}else{echo '';} ?>" />
				</div>
