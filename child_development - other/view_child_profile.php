  ...
  <aside class="right-side">
    ...
    <!-- Main content -->
     ...
     <div class="box-body table-responsive">
      ...
      <form action="view_child_profile.php" method="post" enctype="multipart/form-data">
      <fieldset>
	  	<legend>Approval Section</legend>
       	<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <input type="hidden" name="child_id" value="<?php echo $child_id; ?>" >
          <input type="hidden" name="approval" value="Approved" >
          <tr>
            <td width="56%" colspan="2" align="center">
            <label>
            <input type="submit" class="btn btn-success" name="approve" value="Approved">
            </label>
            </td>
          </tr>
       </table>
