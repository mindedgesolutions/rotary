...
<!-- Main content -->
 ...
 <form role="form" action="master_donar.php" method="post" enctype="multipart/form-data">
 <div class="box-body">
     <?php echo $msg; ?>
     <fieldset>
          ...
          <legend>Donor List</legend>
                ...
                <div class="form-group">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
        <td width="20%"><p>First Name</p></td>
        <td width="20%"><p>Last Name</p></td>
        <td width="25%"><p>Email</p></td>
        <td width="20%"><p>Mobile</p></td>
        <td width="15%"><p>No of Child</p></td>
	  ...
	  ?>
	         <tr>
        <td><p style="color:#0d9429;"><a href='http://rotaryteach.org/child_development/other/view_tagged_child_dtl.php?donorid=<?php echo $donar_id; ?>' target="_blank"><?php echo $first_name; ?></a></p></td>
        ...
        <td><p style="color:#0d9429;"><?php echo $totchild; ?></p></td>
         <td><p style="color:#0d9429;"><a href='master_data.php?id=<?php echo $donar_id; ?>'>Edit</a></p></td>
          <td><p style="color:#0d9429;"><a href='master_data_delete.php?id=<?php echo $donar_id; ?>'>Delete</a></p></td> 
        </tr>
             <?php
	}
	?>
