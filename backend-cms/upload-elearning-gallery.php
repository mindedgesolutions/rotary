...
<div class="wrapper">
 ...
 <?php include('include/header.php'); ?>
    ...
    <?php include 'pagination_elearning.php'; ?>

    <section class="content-header">
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Add/Edit E-Learning Images</li>
      </ol>
    </section>
  <div class="container">
    <div class="row">
    ...
    <div class="col-sm-12">
    <a href="generate-elearning.php"><input type="button" name="addBtn" id="addBtn" class="btn btn-primary" value="Add Image" /></a>
    </div>
      ...
      <div class="col-sm-12">
        ...
        <?php
        $checkRow = mysql_num_rows(mysql_query("select * from image_master where image_id!='' and gallery_type='E-Learning'"));

        if ($checkRow > 0){

          $sln=1;

          $query_getDet = mysql_query("select * from image_master where image_id!='' and gallery_type='E-Learning' order by SLN desc $limit");
          ...
          <tr class="table-tr">
            ...
            <td class="col-sm-2">
              <a href="add-edit-elearning.php?imgid=<?= base64_encode($getDet['image_id']) ?>"><input type="button" name="editBtn" id="editBtn" class="btn btn-primary" value="Edit" style="width: 60px;margin: 0 10px 0 0;" /></a>
      ...
      <?php
        $rowNum = mysql_fetch_array(mysql_query("select count(SLN) as rowCount from image_master where image_id!='' and gallery_type='E-Learning'"));
