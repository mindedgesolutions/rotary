		...
		<div class="container">
			...
			<div class="container">
				...
				if (isset($_REQUEST['saveBtn'])){
					...
					$row = mysql_fetch_array(mysql_query("select max(id) as SLN from asha_kiran_center_rating"));
					...
					$insert = "insert into asha_kiran_center_rating(assessment_id, ngo, center, akc_id, state, project_period, teacher_name, gender, enrolled_boys, enrolled_girls, present_boys, present_girls, visiting_quarter, last_visit_month, current_visit_month, visit_date, stay_duration, status) values('".$eNo."', '".$_REQUEST['ngo']."', '".$_REQUEST['center_name']."', '".$_REQUEST['akc_id']."', '".$_REQUEST['state']."', '".$_REQUEST['project_period']."', '".$_REQUEST['teacher_name']."', '".$_REQUEST['gender']."', '".$_REQUEST['enrolled_boys']."', '".$_REQUEST['enrolled_girls']."', '".$_REQUEST['boys_present']."', '".$_REQUEST['girls_present']."', '".$_REQUEST['quarter']."', '".$_REQUEST['last_visit']."', '".$_REQUEST['current_visit']."', '".$visitDate."', '".$_REQUEST['duration']."', '')";

					mysql_query($insert);
				?>
				<script type="text/javascript">
				alert('Details are saved');
				window.location = 'center-rating-2.php?assessid=<?= base64_encode($eNo) ?>';
				</script>
				<?php
				}
				?>
				...
				<div class="col-sm-12" id="form_section">
					...
					<table width="100%">
						...
						<tr class="table_tr">
							...
							<td colspan="3"><input type="text" name="akc_id" id="akc_id" class="form-control" style="width: 100%;" readonly="readonly" /></td>
						</tr>
						...
						<tr class="table_tr">
							...
							<td colspan="3"><input type="text" name="project_period" id="project_period" class="form-control" style="width: 100%;" /></td>
						</tr>

						<tr class="table_tr">
							<td width="25%" class="table_label">Name of the teacher : </td>
							<td width="45%"><input type="text" name="teacher_name" id="teacher_name" class="form-control" style="width: 100%;" onkeyup="letterswithspace(this)" /></td>
							<td width="15%" class="table_label">Gender : </td>
							<td>
								<input type="radio" name="gender" id="male" value="male" checked="checked" /><label for="male" style="margin: 8px 20px 0 0;">Male</label>
				...
				<div class="col-sm-12" id="form_section">
					...
					<table width="100%">
						...
						<tr class="table_tr">
							...
							<td width="9%"><input type="text" name="enrolled_boys" id="enrolled_boys" class="form-control" style="width: 100%;" onkeyup="numbersOnly(this), gettotalenrolled()" /></td>

							<td width="24%" class="table_label">Total no. of enrolled girls : </td>
							<td width="9%"><input type="text" name="enrolled_girls" id="enrolled_girls" class="form-control" style="width: 100%;" onkeyup="numbersOnly(this), gettotalenrolled()" /></td>

							<td width="24%" class="table_label">Total no. of enrolled children : </td>
							<td width="9%"><input type="text" name="total_enrolled" id="total_enrolled" class="form-control" style="width: 100%;" onkeyup="numbersOnly(this)" readonly="readonly" /></td>
						</tr>

						<tr class="table_tr">
							<td width="24%" class="table_label">No. of boys present : </td>
							<td width="9%"><input type="text" name="boys_present" id="boys_present" class="form-control" style="width: 100%;" onkeyup="numbersOnly(this), gettotalpresent()" /></td>

							<td width="24%" class="table_label">No. of girls present : </td>
							<td width="9%"><input type="text" name="girls_present" id="girls_present" class="form-control" style="width: 100%;" onkeyup="numbersOnly(this), gettotalpresent()" /></td>

							<td width="24%" class="table_label">Children present on the day of visit: : </td>
							<td width="9%"><input type="text" name="total_present" id="total_present" class="form-control" style="width: 100%;" onkeyup="numbersOnly(this)" readonly="readonly" /></td>
						</tr>
					</table>
				</div>
				...
				<div class="col-sm-12" id="form_section">
					...
					<table width="100%">
						...
						<tr class="table_tr">
							...
							<td colspan="3">
								<input type="radio" name="quarter" id="quarter_1" value="quarter_1" checked="checked" /><label for="quarter_1" style="margin: 8px 20px 0 0;">Quarter - I</label>

								<input type="radio" name="quarter" id="quarter_2" value="quarter_2" /><label for="quarter_2" style="margin: 8px 20px 0 0;">Quarter - II</label>

								<input type="radio" name="quarter" id="quarter_3" value="quarter_3" /><label for="quarter_3" style="margin: 8px 20px 0 0;">Quarter - III</label>

								<input type="radio" name="quarter" id="quarter_4" value="quarter_4" /><label for="quarter_4" style="margin: 8px 20px 0 0;">Quarter - IV</label>
							</td>
						</tr>

						<tr class="table_tr">
							<td class="table_label">Month of last visit : </td>
							<td colspan="3"><input type="text" name="last_visit" id="last_visit" class="form-control" style="width: 100%;" readonly="readonly" /></td>
						</tr>

						<tr class="table_tr">
							<td class="table_label">Month of current visit : </td>
							<td colspan="3"><input type="text" name="current_visit" id="current_visit" class="form-control" style="width: 100%;" readonly="readonly" /></td>
						</tr>

						<tr class="table_tr">
							<td class="table_label">Date of visit : </td>
							<td colspan="3"><input type="text" name="visit_date" id="visit_date" class="form-control" style="width: 100%;" readonly="readonly" /></td>
						</tr>

						<tr class="table_tr">
							<td class="table_label">Duration of stay : </td>
							<td colspan="3"><input type="text" name="duration" id="duration" class="form-control" style="width: 80%;float: left;" onkeyup="numbersOnly(this)" /><span style="float: left;line-height: 40px;margin: 0 0 0 15px;">(In hours)</span></td>
						</tr>
					</table>
				</div>
