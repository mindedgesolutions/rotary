		...
		<div class="col-sm-12">
			...
			<table width='100%', border='1px dashed' style='font-family: Droid Sans, sans-serif;'>
				<thead>
				  	...
				  	<th width='100%' colspan="10" style='background-color:#1980cf; text-align:center; color:#ffffff;'>
			...
			?>
				<tr class='headercol'>
					<td class='pad' style="text-align: center;" onclick="openProfile(<?= $row['child_id'] ?>)"><?= $i ?></td>
