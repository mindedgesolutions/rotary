...
$query2=mysql_query("SELECT * from rihf_content where text_heading='SAVING LITTLE HEARTS' limit 0,1");
	...
	<?php       
	 ...
	 ?>
        ...
        <td align="left" valign="top" class="text"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" valign="top"><span class="heading1">SAVING</span> <span class="heading2">LITTLE HEARTS</span><br />
              <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="success_stories.php?type=Saving Litthe Hearts" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','images/successa.png',1)"><img src="images/success.png" name="Image17" width="171" height="48" border="0" id="Image17" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
