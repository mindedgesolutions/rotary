        ...
        <td width="210" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="185" align="left" valign="top" style="padding:10px">
				<ul id="portfolio">
	<?php       
	 ...
	 ?>
				<li>
				<a href="friends.php">
				<img src="<?php echo $searchNode->getAttribute('path'); ?>" width="189" height="141" />				</a>				</li>
				<?php } ?>
				</ul>				</td>
              </tr>
            </table></td>
        ...
        <td align="left" valign="top" class="text"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<div align="left"  style="border:3px solid #000; -webkit-box-shadow: #B3B3B3 0px 0px 10px;-moz-box-shadow: #B3B3B3 0px 0px 10px; box-shadow: #B3B3B3 0px 0px 10px; width:470px; height:243px;">
			<div id="container">
			  <div id="slides">
			    ...
			    ?>	<div class="slide">
                      <div class="caption" style="top:0; height:50px; font-size:18px">
						...
						<a href="news.php">
						<img src="<?php echo "uploads/news/".$res['text_details']; ?>" width="470" height="243" /></a>
						<div class="caption" style="bottom:0">
							<p><?php echo substr($res['text_dscription'],0,135)."..."; ?></p>
						</div>
					</div>
					<?php } ?>			
				</div>
