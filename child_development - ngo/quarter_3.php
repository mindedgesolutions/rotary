...
foreach($quarter as $value){
 $sql = "Insert into quarter_3 values(NULL,'$child_id','$exam','$value','$date_of','$create_by')";	
 echo $sql;
 $result = mysql_query($sql);
...
<!-- Main content -->
 ...
 <div class="box-body">   
     <?php echo $msg; ?>      
     <form action="quarter_3.php" method="post" enctype="multipart/form-data"> 
          <fieldset>
         ...
         <table width="100%" border="1">
          <tr>
            ...
            <td width="16%" align="center"><strong>3rd Quarter</strong></td>
          </tr>
          <?php
          ...
          <tr>
            ...
            <input type="hidden" class="form-control"  name="exam" value="3"/>
