...
$sql = "Update tbl_child_profile_card SET child_photo = IF('$image_name'='','$pd_img_02','$image_name'),child_name = '$child_name',child_gender = '$child_gender',child_dob = '$child_dob',child_father_name = '$father_name',child_mother_name = '$mother_name',child_gaurdian_name = '$child_gaurdian',previously_study = '$child_study',address = '$child_address',street = '$child_street',city = '$child_city',state = '$child_state',
 pin = '$child_pin',name_partner_ngo = '$ngo_partner',ngo_representative = '$ngo_representative',ngo_contact = '$ngo_contact',
 create_by = '$profile_createdby',create_date = '$create_date' where child_id = '$child_id'";
...
<!-- Main content -->
 ...
 <form role="form" action="edit_child_profile.php" method="post" enctype="multipart/form-data">
 <div class="box-body">
     <?php echo $msg; ?>
     <fieldset>
      ...
      <div class="form-group">
       ...
       <input type="text" class="form-control" name="child_name" required value="<?php echo $child_name; ?>"/>
      </div> 
      <div class="form-group">
       <label>Gender</label>
       <?php
      ...
      <div class="form-group">
       ...
       <input type="text" class="form-control" name="child_dob" value="<?php echo $child_dob;?>" required/>
      </div> 
      <div class="form-group">
       <label>Father Name</label>
       <input type="text" class="form-control" name="father_name" value="<?php echo $child_father_name; ?>" required/>
      </div> 
      <div class="form-group">
       <label>Mother Name</label>
       <input type="text" class="form-control" value="<?php echo $child_mother_name; ?>" name="mother_name"/>
      </div> 
      <div class="form-group">
       <label>Child Gaurdian</label>
       <input type="text" class="form-control" value="<?php echo $child_guardian_name; ?>" name="child_gaurdian"/>
      </div> 
      <div class="form-group">
       <label>Child has previously studied upto which standard/class?</label>
       <?php
	   $c = "";
	   $sql = "Select `previously_study` from tbl_child_profile_card where child_id = '$pid'";
	   $res = mysql_query($sql);
	   while($data = mysql_fetch_array($res)){
	   if($data['previously_study']=="yes"){
		 $c = "checked=checked";
		}
		else{
		 $c="";
	   ...
	   ?> 
       <input type="checkbox" class="form-control" name="studied" value="yes" <?php echo $c; ?>/>
      </div> 
      <div class="form-group">
       <label>Address</label>
	  ...
	  <!--      
	  <div class="form-group">
       <label>You Belong To</label>
       <select name="type" id="catagory" onChange="loadXMLDoc(this.value);" required>
        <option value="">Select Type</option>
        <?php 
			$i=0;
			$sql_c="select * from  tbl_member_type";
			$result_c= mysql_query($sql_c);
			while($row_c = mysql_fetch_array($result_c)){			
			
			if($row_c['member_type']== $ri_type){
			$c='selected="selected"';
			} 
			else{
			$c="";
            ...
            <option value="<?php echo $row_c['member_type'];?>" <?php echo $c; ?>><?php echo $row_c['member_type']; ?></option>
            <?php $i++; } ?>
       </select>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
       <label>Pin</label>
       <input type="text" class="form-control" value="<?php echo $pin; ?>"name="pin" required/>
      </div>
      </fieldset>
      <fieldset>
      ...
      <div class="form-group">
       ...
       <input type="text" class="form-control" value="<?php echo $name_partner_ngo; ?>" name="ngo_partner" required/>
      </div>
      <div class="form-group">
       <label>Name of NGO Representative</label>
       <input type="text" class="form-control" value="<?php echo $ngo_representative; ?>" name="ngo_rep"/>
      </div>
      <div class="form-group">
       <label>Contact</label>
       <input type="text" class="form-control" value="<?php echo $ngo_contact; ?>" name="ngo_contact"  required/>
      </div>
