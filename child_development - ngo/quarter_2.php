...
$sql = "Insert into tbl_child_progress_card values(NULL,'$child_id','$date_admission_center','$age_class','$create_by')";
echo $sql;
$result = mysql_query($sql);	
if($result){
foreach($quarter as $value){
 $sql = "Insert into quarter_2 values(NULL,'$child_id','$exam','$value','$date_of','$create_by')";	
 echo $sql;
 $result = mysql_query($sql);
     ...
     <form action="quarter_2.php" method="post" enctype="multipart/form-data"> 
              ...
              <tr>
                ...
                <table width="100%" border="0">
                  ...
                  <tr>
					...
					{echo $date_admission_center;} else{}?>" required/>
                    </td>
                    <td>
         ...
         <table width="100%" border="1">
          <tr>
            ...
            <td width="16%" align="center"><strong>2nd Quarter</strong></td>
          </tr>
          <?php
          ...
          <tr>
            ...
            <td><input type="text" class="form-control" name="quarter[]" value="" required/></td>
