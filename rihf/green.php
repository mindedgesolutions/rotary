...
$query2=mysql_query("SELECT * from rihf_content where text_heading='GREEN MAGIC' limit 0,1");
	...
	<?php       
	 ...
	 ?>
        ...
        <td align="left" valign="top" class="text"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" valign="top"><span class="heading1">GREEN</span> <span class="heading2">MAGIC</span><br /><br />
 <table width="697" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td> <br /><?php echo $rec2['text_dscription'];?></td>
  </tr>
  <tr>
    <td align="right"><a href="donate.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','images/save_4a.png',1)"><img src="images/save_4.png" name="Image15" width="239" height="48" border="0" id="Image15" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="volunteer.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image16','','images/vol.png',1)"><img src="images/vola.png" name="Image16" width="143" height="47" border="0" id="Image16" /></a></td>
  </tr>
  <tr>
  <td><img src="uploads/content/<?php echo $rec2['text_details'];?>" width="427" /></td>
  </tr>
</table>
			</td>
          </tr>
