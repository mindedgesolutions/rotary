...
function showeLearning2(){
		...
		document.getElementById("i_projector").checked = false;
		document.getElementById("i_board").checked = false;
		document.getElementById("tablets").checked = false;
		document.getElementById("chkELearnOther").checked = false;
		document.getElementById("txtELearnOther").value="";
		document.getElementById("txteLearning").value="";
		document.getElementById("txteLearningWhen").value="";
		document.getElementById("txteLearningComprise").value="";
}		
function showOther5()
{
...
<div id="sumitone">                                      
	...
	<form class="form-horizontal" name="frm" id="frm" action="edit_school_survey_maharashtra_gov.php" method="POST" enctype="multipart/form-data">	
									...
									<center>
										<h4 class="heading">PERSONAL DETAILS OF THE PERSON FILLING THE FORM</h4>
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input type="text" id="txtPersonName" name="txtPersonName" class="form-control" readonly value="<?php echo $fullname; ?>" onkeyup="nospecial(this)" >   
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Postal Address :</td>
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtAddress" name="txtAddress" readonly value="<?php echo $address; ?>" onkeyup="nospecial(this)" >   
                                                    </td>
                                                </tr>
												<tr>
		...
		<?php
			...
			?>	
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<input type="text" id="txtSchoolName" name="txtSchoolName" class="form-control" value="<?php echo $school_name; ?>" onkeyup="nospecial(this)" >
													</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-md-8">
														<input type="text" id="txtudiseno" name="txtudiseno" maxlength="11" class="form-control" value="<?php echo $udise_no; ?>" required onkeypress="return IsNumeric201(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<input type="text" id="txtSchoolHead" name="txtSchoolHead" class="form-control" value="<?php echo $head_teacher_name; ?>" onkeyup="nospecial(this)" >
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Phone Number :</td>
                                                    <td class="col-md-8">
														<input class="form-control" type="text" id="txtSchoolPhoneNo" name="txtSchoolPhoneNo" maxlength="10" required onkeypress="return IsNumeric2(event);" ondrop="return false;" onpaste="return false;" value="<?php echo $school_ph_no; ?>" />
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8"> <!-- onblur="checkEmail1(this.value)" -->
                                                     <input class="form-control" type="text" id="txtSchoolEmailID" name="txtSchoolEmailID" value="<?php echo $school_email; ?>" >
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtSchoolState" name="txtSchoolState" value="<?php echo $school_state; ?>" >  
                                                    </td>
                                                </tr>
												<!-- new-->
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtDistrict" name="txtDistrict" value="<?php echo $school_dist; ?>"  >  
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Tehsil :</td>
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtTehsil" name="txtTehsil" value="<?php echo $school_tehsil; ?>" onkeyup="nospecial(this)"  >  
                                                    </td>
                                                </tr>
												<!-- new-->
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtSchoolVillage" name="txtSchoolVillage" value="<?php echo $village; ?>" onkeyup="nospecial(this)" >  
                                                    </td>
                                                </tr>
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtSchoolPin" name="txtSchoolPin" maxlength="6" required 
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtSchoolWebsite" name="txtSchoolWebsite" value="<?php echo $school_website; ?>" >  
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">School Category :</td>
                                                    <td class="col-md-8">
														<label class="radio-inline" for = "Primary"><input type = "radio" name = "schoolcat" id = "Primary" value = "Primary" <?php if($school_cat=='Primary'){echo $chk;} ?> />Primary (up to V)</label>&nbsp;&nbsp;&nbsp;&nbsp;
														<label class="radio-inline" for = "innerwheel"><input type = "radio" name = "schoolcat" id = "Elementary" value = "Elementary" <?php if($school_cat=='Elementary'){echo $chk;} ?> />Elementary (up to VIII)</label></br>
														<label class="radio-inline" for = "rotaract"><input type = "radio" name = "schoolcat" id = "Secondary" value = "Secondary" <?php if($school_cat=='Secondary'){echo $chk;} ?>  />Secondary (up to X)</label>
														<label class="radio-inline" for = "rotaract"><input type = "radio" name = "schoolcat" id = "SeniorSecondary" value = "SeniorSecondary" <?php if($school_cat=='SeniorSecondary'){echo $chk;} ?> />Senior Secondary (up to XII)</label>
		...
		<tr>
                                                    ...
                                                    <td class="col-md-8">
														<label class="radio-inline" for = "Girls"><input type = "radio" name = "schooltype" id = "schoolTypeGirls" onchange="schoolType1()" value = "Girls" <?php if($school_type=='Girls'){echo $chk;} ?> />Girls</label>&nbsp;&nbsp;&nbsp;&nbsp;
														<label class="radio-inline" for = "Boys"><input type = "radio" name = "schooltype" id = "schoolTypeBoys" onchange="schoolType2()" value = "Boys" <?php if($school_type=='Boys'){echo $chk;} ?> />Boys</label>
														<label class="radio-inline" for = "Co-Educational"><input type = "radio" name = "schooltype" id = "schoolTypeCoEdu" onchange="schoolType3()" value = "Co-Educational" <?php if($school_type=='Co-Educational'){echo $chk;} ?>  />Co-Educational</label>
			...
			<tr>												
                                                    ...
                                                    <td class="col-md-8">
														<label id="girl">Girls:</label><input type="text" id="txtNoOfGirls" name="txtNoOfGirls" class="form-control" maxlength="3" onblur="add1()" required onkeypress="return IsNumeric15(event);" ondrop="return false;" onpaste="return false;" value="<?php echo $stud_girls; ?>" />
														<span id="error15" style="color: Red; display: none">* Input digits (0 - 9)</span>
														<label id="boy">Boys:</label><input type="text" id="txtNoOfBoys" name="txtNoOfBoys" class="form-control" maxlength="3" onblur="add1()" required onkeypress="return IsNumeric16(event);" ondrop="return false;" onpaste="return false;" value="<?php echo $stud_boys; ?>" />
														<span id="error16" style="color: Red; display: none">* Input digits (0 - 9)</span>
														<label id="boygirltotal">Total:</label><input type="text" id="txtTotalStudent" name="txtTotalStudent" class="form-control" value="<?php echo $stud_total; ?>" readonly>
			...
			<!-- onclick="showMaleTeacherNotAval(this)" -->
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">
														...
														<input type="text" id="txtMale" name="txtMale" class="form-control" maxlength="3" onblur="add2()" required onkeypress="return IsNumeric17(event);" ondrop="return false;" onpaste="return false;" value="<?php echo $teacher_male; ?>"  />
														...
														<input type="text" id="txtFemale" name="txtFemale" class="form-control" maxlength="3" onblur="add2()" required onkeypress="return IsNumeric4(event);" ondrop="return false;" onpaste="return false;" value="<?php echo $teacher_femail; ?>" />
											...
											<tr style="display:none;">												
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">	
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "eLearning" id = "eLearning_yes" value = "yes" onchange="showeLearning1()" <?php if($e_learning_fac=='yes'){echo $chk;} ?> />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "eLearning" id = "eLearning_no" value = "no" onchange="showeLearning2()" <?php if($e_learning_fac=='no'){echo $chk;} ?>  />No</label>																												
														<br>
														<table id="ideLearning" <?php if($e_learning_fac=='yes'){ ?>style="display:block;" <?php } else { ?> style="display:none;" <?php } ?> >
															...
															<?php  
																...
																?>
															<tr>
																<td style="width:50%"><input type="checkbox" name="chkELearn[]" value="Television" id="television" <?=(in_array('Television', $eLearnOption)?'checked="checked"':NULL)?>>&nbsp;Television</td>
																<td style="width:50%"><input type="checkbox" name="chkELearn[]" value="Projector with ceiling mount" id="projector" <?=(in_array('Projector with ceiling mount', $eLearnOption)?'checked="checked"':NULL)?> >&nbsp;Projector with ceiling mount</td>
																
															</tr>
															<tr>
																<td><input type="checkbox" name="chkELearn[]" value="Integrated projector" id="i_projector" <?=(in_array('Integrated projector', $eLearnOption)?'checked="checked"':NULL)?> >&nbsp;Integrated projector</td>
																<td><input type="checkbox" name="chkELearn[]" value="Integrated white boards" id="i_board" <?=(in_array('Integrated white boards', $eLearnOption)?'checked="checked"':NULL)?> >&nbsp;Integrated white boards</td>
															</tr>
															<tr>
																<td><input type="checkbox" name="chkELearn[]" value="Tablets" id="tablets" <?=(in_array('Tablets', $eLearnOption)?'checked="checked"':NULL)?> >&nbsp;Tablets</td>
																<td><input type="checkbox" name="chkELearn[]" id="chkELearnOther" onclick="showELearn(this)" value="Others" <?=(in_array('Others', $eLearnOption)?'checked="checked"':NULL)?> >&nbsp;Others
																</td>
															</tr>
															
															<tr>
																<td>
																	<table id="idELearnOther" <?=(in_array('Others', $eLearnOption)?'checked="checked"':NULL)?>>
																		<tr>
																			<td colspan="2">
																				Other :<input type="text" id="txtELearnOther" name="txtELearnOther" class="form-control" value="<?php echo $e_learning_other; ?>"" >	
																			</td>
																		</tr>
																	</table>
																</td>
															...
															<tr>
																<td>
																<br/>
																	how many functional units :<input type="text" id="txteLearning" name="txteLearning" class="form-control" value="<?php echo $e_learning_func_unit; ?>" maxlength="3" required onkeypress="return IsNumeric34(event);" ondrop="return false;" onpaste="return false;" />
															...
															<tr>
																<td>
																<br/>
																	What does an e-learning unit comprise of :<input type="text" id="txteLearningComprise" name="txteLearningComprise" class="form-control" value="<?php echo $e_learning_unit_comp; ?>"   />
																</td>
															</tr>
									...
									<center>
										...
										<h5 class="heading">Status of Physical Education</h5>
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<textarea class="form-control" rows="5" id="otherInfo" name="otherInfo" onkeyup="nospecial(this)" ><?php echo $any_other_info_not_covered; ?></textarea>
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Name of the person submitting this form</td>
                                                    <td class="col-md-8">
														<input type="text" id="txtNameOfPerson" name="txtNameOfPerson" class="form-control" value="<?php echo $name_who_fill_form; ?>" required onkeyup="nospecial(this)" >
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Designation of the person submitting this form</td>
                                                    <td class="col-md-8">
														<input type="text" id="txtDesigOfPerson" name="txtDesigOfPerson" class="form-control" value="<?php echo $desig_who_fill_form; ?>" required onkeyup="nospecial(this)">
                                                    </td>
                                                </tr>
								<?php } ?>	
												<tr>
