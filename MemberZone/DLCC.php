            ...
            <tr>
                <td>
                	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            <td align="left" valign="bottom"><h1>DLCC Details</h1></td>
                    ...
                    <div style="height:2px; border-bottom:2px solid #999999; border-top:1px solid #999999; margin-top:5px"></div>
   					<form name="frm" action="CSV/DLCCCSV.php" method="post">
...
<tr>
<td style="text-align:center; font-weight: bold"><?php echo $record["district"]; ?></td>
