      ...
      <tr>
        ...
        <td align="left" valign="top" class="text"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<?php
            $query2=mysql_query("select * from rihf_friends_content order by updtime desc"); 
			...
			<tr>
                <td align="left" valign="top" class="inner_bot"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="10">
                  <tr>
                    <td width="141" align="left" valign="top" class="album_pic"><img src="uploads/friendsslider/<?php echo $rec4['text_details']; ?>" width="140" height="104" border="0" style="border:6px solid #FFF; -webkit-box-shadow: #B3B3B3 0px 0px 10px;-moz-box-shadow: #B3B3B3 0px 0px 10px; box-shadow: #B3B3B3 0px 0px 10px;" /></td>
                    <td align="left" valign="top"><strong style="font-size:16px; color:#333; font-weight:bold"><b><?php echo $rec4['text_heading']; ?>:</b></strong><br />
                       <?php echo $rec4['text_dscription']; ?> 
						</td>
                  </tr>
                </table></td>
              </tr>
