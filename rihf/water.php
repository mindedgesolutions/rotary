...
$query2=mysql_query("SELECT * from rihf_content where text_heading='WATER HARVESTING' limit 0,1");
	...
	<?php       
	 ...
	 ?>
        ...
        <td align="left" valign="top" class="text"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" valign="top"><span class="heading1">WATER&nbsp;</span> <span class="heading2"> HARVESTING</span><br /><br />
