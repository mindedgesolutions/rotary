...
<span style="font-weight:bold; color:#FF0000; font-size:12px; font-family:Arial, Helvetica, sans-serif">You need to be minimum 18 years of age to register as volunteer.</span>
<?php }?>
...
<?php 
$disttext = '';
if($_GET["for"]!='Inner Wheel Member' && $_GET["for"]!='Others' && $_GET["for"]!='Rotaractor' && $_GET["for"]!='RCCMember') { 
...
<tr>
    ...
    <td class="link">
        ...
        <input type="checkbox"  class="voluntarea" name="choVolntArea[]" value="Child Psychology" /><A HREF=""><strong>Child Psychology</strong></a><br />
   		<br />
    	<input type="checkbox"  class="voluntarea" name="choVolntArea[]" value="workprogram" /><A HREF="javascript:popUp('o.htm')"><strong>Admin / HR</strong></a><br />
    	<input type="checkbox"  class="voluntarea" name="choVolntArea[]" value="fundraising" /><A HREF="javascript:popUp('f.htm')"><strong>Fund Raising</strong></a><br />
        <input type="checkbox"  class="voluntarea" name="choVolntArea[]" value="research" /><A HREF="javascript:popUp('re.htm')"><strong>Research / Analysis</strong></a><br />
    	<input type="checkbox"  class="voluntarea" name="choVolntArea[]" value="communication" /><A HREF="javascript:popUp('pr.htm')"><strong>PR / Communications</strong></a><br />
    </td>
</tr>
<tr><td colspan="3"></td></tr>
<tr>
