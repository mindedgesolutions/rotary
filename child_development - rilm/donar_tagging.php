...
$donar_district = $_POST['donar_district'];
$date_of = date('d-m-Y');
$time_of = date('h:i:sa');
...
while($data = mysql_fetch_array($res)){
 extract($data);
$qry="UPDATE tbl_child_selected_tagging SET donar_id = '$donar_id', date_of = '$date_of', time_of = '$time_of', donor_email = '$donar_email' where donar_id = ''";
$result = mysql_query($qry);

$qry32="UPDATE tbl_donar_master SET tagged = 'yes' where donar_id = '$donar_id'";
$result = mysql_query($qry32);
...
';
   ...
   /*if($donar_email == ''){
	$donar_district = $_POST['donar_district'];
	$sql_query = "Select * from dg_list where district = '$donar_district'";
	$resu = mysql_query($sql_query);
	while($data_bank = mysql_fetch_array($resu)){
		extract($data_bank);
	}
    $to = $dg_email; // Email address of the Receiver.
	$subject = "";
	$message = 'Dear Donor,
...
To see the child/children that you have sponsored, follow the link http://www.rotaryteach.org/child_development/other/  or visit the ‘My Asha Kiran Child’ tab on our website.
Once you visit the link/website you have to create an account with your name and email id as mentioned below:

Name:'.$donar_name.'

Now only you can access the details of the child that you have sponsored under Asha Kiran. We thank you once more for investing in the future of a child through Asha Kiran. You are indeed doing good in this world by supporting Asha Kiran… a ray of hope program.
            ...
            <td>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="10%"><p>Donar District</p></td>
                    <td width="14%"><p>Donar Club</p></td>
                    <td width="14%"><p>Donar Name</p></td>
                    <td width="14%"><p>Donar Email</p></td>
                    <td width="16%"><p>Donar City</p></td>
                    <td width="22%"><p>Amount for No of Child</p></td>
                    <td width="22%"><p>Tagged</p></td>
                  </tr>
               </table>
            </td>
          </tr>
               ...
               <div style="width:100%; height:253px; overflow:auto;">
                 ...
                 <table cellspacing="0" cellpadding="1" border="1" width="100%" >
                   ...
                   <?php
					...
					?>
					 <tr>
						<td width="10%" align="center"><input name="donar_tag" type="radio" value="<?php echo $donar_id; ?>"></td>
						<td width="10%"><p><?php echo $donar_district; ?></p></td>
						<td width="14%"><p><?php echo $donar_club; ?></p></td>
						<td width="14%"><p><?php echo $first_name.' '.$last_name; ?></p></td>
                        <td width="14%"><p><?php echo $donar_email; ?></p></td>
						<td width="16%"><p><?php echo $donar_city; ?></p></td>
						<td width="22%"><p><?php echo $amount_no_child; ?></p></td>
                        <td width="22%"><p><?php echo $tagged; ?></p></td>
                        <input type="hidden" name="donar_name" value="<?php echo $first_name.' '.$last_name; ?>">
                        <input type="hidden" name="donar_email" value="<?php echo $donar_email; ?>">
                        <input type="hidden" name="donar_district" value="<?php echo $donar_district; ?>">
					  </tr> 
					<?php
					 }
					?>
