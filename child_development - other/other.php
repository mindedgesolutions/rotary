  ...
  <div class="header">
    ...
    <div class="tab-pane active" id="tab_1">
          ...
          <div class="body bg-gray">
            <p><?php echo $msg; ?></p>
           <form action="other.php" name="tagged" method="post" enctype="multipart/form-data">
        <table width="100%" border="0">
          <tr>
            ...
            <?php 
		    $sql=mysql_query("Select DISTINCT donar_email from tbl_donar_master where tagged = 'yes' and donor_club == '' ORDER BY donar_district");
