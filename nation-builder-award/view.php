...
function openFancyBox(par){
  ...
  $(document).ready(function() {
    ...
    type: 'iframe',
    scrolling: 'no',
    href: 'view_image.php?sln=' + sln + '&prno=' + prno + '&schoolId=' + schoolId + '&schoolName=' + encodeURIComponent(schoolName) + '&schoolType=' + schoolType + '&no_teacher_evaluated=' + no_teacher_evaluated + '&no_teacher_awarded=' + no_teacher_awarded + '&subject=' + subject + '&distDate=' + distDate + '&schoolNo=' + schoolNo,
    /*'afterClose':function () {
          ...
          <div class="col-md-10" style="margin: 50px 0;">
            ...
            <table>
              ...
              <tr>
                ...
                <td width="25%"><input type="text" name="schoolNo" id="schoolNo" value="<?= $details['no_schools'] ?>" class="form-control" readonly="readonly" /></td>
                <td width="50%">&nbsp;</td>
              </tr>
            ...
            <table border="1" style="border-collapse: collapse;">
              ...
              <tr class="table-row">
                ...
                <td style="line-height: 18px;width: 8%;height: 50px;line-height: 50px;font-size: 90%;padding: 0 5px;">
                  <input type="text" name="schoolId<?= $i ?>" id="schoolId<?= $i ?>" value="<?= $getDet['school_id'] ?>" class="form-control" readonly="readonly" />
                </td>

                <td style="line-height: 18px;width: 12%;height: 50px;line-height: 50px;font-size: 90%;padding: 0 5px;">
                  <input type="text" name="schoolName<?= $i ?>" id="schoolName<?= $i ?>" value="<?= urldecode($getDet['school_name']) ?>" class="form-control" readonly="readonly" />
                </td>
                ...
                <td style="line-height: 18px;width: 18%;height: 50px;line-height: 50px;font-size: 90%;padding: 0 5px;">
                  <input type="text" name="no_teacher_evaluated<?= $i ?>" id="no_teacher_evaluated<?= $i ?>" value="<?= $getDet['teacher_evaluated'] ?>" class="form-control" readonly="readonly" />
                </td>

                <td style="line-height: 18px;width: 10%;height: 50px;line-height: 50px;font-size: 90%;padding: 0 5px;">
                  <input type="text" name="no_teacher_awarded<?= $i ?>" id="no_teacher_awarded<?= $i ?>" value="<?= $getDet['teacher_awarded'] ?>" class="form-control" readonly="readonly" />
                </td>

                <td style="line-height: 18px;width: 15%;height: 50px;line-height: 50px;font-size: 90%;padding: 0 5px;">
                  <input type="text" name="subject<?= $i ?>" id="subject<?= $i ?>" value="<?= $getDet['subject_taught'] ?>" class="form-control" readonly="readonly" />
                </td>

                <td style="line-height: 18px;width: 15%;height: 50px;line-height: 50px;font-size: 90%;text-align: center;">
                  <input type="button" name="showImg<?= $i ?>" id="showImg<?= $i ?>" value="Details" class="btn btn-primary" onclick="openFancyBox(<?= $i ?>)" />
                </td>
              </tr>
              <?php $i++;} ?>
            </table>
