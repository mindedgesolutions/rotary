...
<form name="frmgrantapp" action="" method="post">
                ...
                <tr>
                    <td width="43%"><strong>Grant Title <span style="color:#ff0000">*</span></strong></td>
                    <td width="2%"><strong>:</strong></td>
                    <td width="55%"><select id="txtgranttitle" name="txtgranttitle">
									...
									<option value="Happy School (HS)" selected="selected">Happy School (HS)</option>
									</select>					</td>
                </tr>
				
                <!--<tr>
                    <td><strong>Status <span style="color:#ff0000">*</span></strong></td>
                    <td><strong>:</strong></td>              
				 ...
				 <tr>
                    <td><strong>You are from <span style="color:#ff0000">*</span></strong></td>
                    <td><strong>:</strong></td>              
                    <td><input type="radio" name="txtbelong" value="Rotary" onclick="changeDistrict(this.value)" />Rotary Clubs&nbsp;
				 ...
				 <tr id="districttr" style="display:none">
                    ...
                    <td><strong>:</strong></td>              
                    <td>
					<span id="rotdistrict" style="display:none"><input type="text" id='txtRotDistrict' name='txtRotDistrict'  readonly="readonly" value="<?php echo $district;?>" /></span>
						
					<span id="innerdistrict"  style="display:none"><input type="text" name="txtinnerdistrict" id="txtinnerdistrict"   readonly="readonly" onKeyPress="inputNumber(event,this.value,false);"  maxlength="4"  value="<?php echo $district;?>" />
					</span>					</td>
                </tr>
				 
				
				<!-- <tr>
                    <td><strong>District Number  <span style="color:#ff0000">*</span></strong></td>
                    <td><strong>:</strong></td>              
                    <td><input type="text" name="txtdistrict" id="txtdistrict"  onKeyPress="inputNumber(event,this.value,false);"  maxlength="4" /> </td>
                </tr>-->
				
				<tr>
                    <td><strong>TRF Qualification Status of Club / District  <span style="color:#ff0000">*</span></strong></td>
                    <td><strong>:</strong></td>              
                    <td><input type="radio" name="qualifstatus" value="Qualified"/>Qualified &nbsp;
						<input type="radio" name="qualifstatus" value="Not Qualified"/>Not Qualified&nbsp;                </tr>
                ...
                <tr>
                    <td colspan="3" align="center">
                        ...
                        <input type="reset" name="btn_reset" id="btn_reset" value="Cancel"  class="login" style="cursor:pointer; border-radius:3px" />                        &nbsp;&nbsp;					</td>
                    </tr>
</form>         
</table>
