...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="as-fancytitle"> <h2>Upcoming Activities</h2> </div>
  ...
  <ul class="row">
      <li class="col-md-3" style="height: 275px;border: 1px solid #fff;">
        <div class="event-wrap hovereffect" style="border:none;">
          <figure>&nbsp;</figure>
  ...
  <?php
  $query_getDet = mysql_query("select * from rotary32_teach2.future_act where status='activate' order by SLN desc limit 4");
  ...
  ?>
      <li class="col-md-3" style="height: 275px;">
        <div class="event-wrap hovereffect">
          <figure><img class="btn btn-lg" src="../backend-cms/<?= $getDet['image'] ?>" alt="" title="" data-toggle="modal" data-target="#future_<?= $getDet['SLN'] ?>"></figure>
          <div class="as-event-info">
            <div class="as-info-wrap">
      ...
      <div class="modal" id="future_<?= $getDet['SLN'] ?>" role="dialog">
