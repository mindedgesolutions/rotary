...
if(isset($_POST['submit_form'])){
  ...
  for ($i=0; $i<16; $i++){
    ...
    if ($checkPresent < 16){
      ...
      $insert = "Insert into ".$table."(quater_id, child_id, exam, value, date_of, create_by, subject_id, year, updated_by) values(NULL, '".$pid."', '".$exam_id."', '".$sub_marks."', '".$date_of."', '".$create_by."', '".$sub_id."', '".$_REQUEST['quarterYear']."', '".$_SESSION['username']."')";

      mysql_query($insert);

    }else{

      $update = "update ".$table." set value='".$sub_marks."' where child_id='".$pid."' and subject_id='".$sub_id."' and year='".$_REQUEST['quarterYear']."'";
...
<div class="container">
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="content-wrapper">
					...
					<div class="col-md-5">
					  ...
					  <div>
						<div class="data"><span class="dataLabel">Child Name :</span><?= strtoupper($getDet['child_name']) ?></div>
					  </div>

						<div>
						<div class="data"><span class="dataLabel">Child DOB :</span><?= $getDet['child_dob'] ?></div>
					  </div>
					  
					    <div>
						
						<div class="data"><span class="dataLabel">Child Gender :</span> <?= strtoupper($getDet['child_gender']) ?></div>
						</div>
    
						<div>
						
						<div class="data"><span class="dataLabel">Father's Name :</span><?= strtoupper($getDet['child_father_name']) ?></div>
						</div>
    ...
    <div class="col-md-5">
      ...
      <div>
        ...
        <div class="data"><span class="dataLabel">Mother's Name :</span><?= strtoupper($getDet['child_mother_name']) ?></div>
      </div>

      <div>
       
        <div class="data"><span class="dataLabel">Child's City :</span><?= strtoupper($getDet['city']) ?></div>
      </div>

     <!-- <div>
       
        <div class="data"><span class="dataLabel">Pin Code :</span><?php if ($getDet['pin']==''){echo 'N/A';}else{echo ucwords($getDet['pin']);} ?></div>
      </div>

      <div>-->
      
        <div class="data"><span class="dataLabel">NGO Partner :</span><?= strtoupper($getDet['name_partner_ngo']) ?></div>
      </div>
	  </div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-5">
        <div class="data">
          <h1>Select Year : </h1>
          <select class="form-control" name="quarterYear" id="quarterYear" required>
    ...
    <div class="btn-holder">
      ...
      <a href="child_progress_report.php"><input type="button" name="backBtn" class="btn btn-primary" value="Back" style="float: right;margin: 0 15px 0 0;" ></a>
    </div>
  </div>
  </form>
  </div>
