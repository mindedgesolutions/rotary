...
<div class="row">
  ...
  <?php
  $query_getDet = mysql_query("select * from rotary32_teach2.present_act where status='activate' order by SLN desc limit 4");
  ...
  ?>
      <li class="col-md-3" style="height: 275px;">
        <div class="event-wrap hovereffect">
          <figure><img class="btn btn-lg" src="../backend-cms/<?= $getDet['image'] ?>" alt="" title="" data-toggle="modal" data-target="#present_<?= $getDet['SLN'] ?>"></figure>
      ...
      <div class="modal" id="present_<?= $getDet['SLN'] ?>" role="dialog">
