...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Donar record delete</li>
  </ol>
</section>
<!-- Main content -->
 ...
 <div class="box-body">
     ...
     <fieldset>
      ...
      <input type="submit" name="submit" class="btn btn-primary" value="Submit" />
          ...
          <legend>Donar List</legend>

                <div class="form-group">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
        <td width="22%"><p>First Name</p></td>
        <td width="22%"><p>Last Name</p></td>
        <td width="22%"><p>Email</p></td>
        <td width="22%"><p>Mobile</p></td>
        <td width="12%"><p>Delete</p></td>
	  ...
	  ?>
        ...
        <td><p style="color:#0d9429;"><a href='master_data.php?id=<?php echo $donar_id; ?>'>Delete</a></p></td>
        </tr>
             <?php
	}
	?>
