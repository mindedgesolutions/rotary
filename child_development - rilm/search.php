...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <aside class="right-side">
     ...
     <table width="100%" border="0">
      <tr>
        ...
        <option value="">Center Name</option>
       	<?php 
        $sql=mysql_query("select DISTINCT `city` from tbl_child_profile_card");
   ...
   if($center_name != '' || $child_name != ''){
	 $sql = "Select * from tbl_child_profile_card where city = '$center_name' OR child_name = '$child_name'";  
	 $res = mysql_query($sql);
	 echo '<br/><br/>
	 ...
	 ?>	 
      <tr>
        ...
        &nbsp;
        <a href="search.php?del=<?php echo $child_id; ?>" class="ask"><button class="btn btn-danger btn-sm">Delete</button></a>
        </p></td>
      </tr>
     <?php 
	  }
