...
function finalSubmission()
{
	...
	if(document.getElementById("txtSchoolName").value=="")
	{
		...
		document.getElementById("txtSchoolName").style.box-shadow="0px 0px 25px #ff0000";
		return false;
	}
											...
											<tr>												
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">																												
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "toiletforteacher" id = "yes" value = "yes" onchange="showToiletTeacher1()" <?php if($toilet_for_teachers=='yes'){echo $chk;} ?> />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "toiletforteacher" id = "no" value = "no" onchange="showToiletTeacher2()" <?php if($toilet_for_teachers=='no'){echo $chk;} ?> />No</label>	
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<label class="radio-inline" for = "yes"><input type = "radio" name = "washStation" id = "yes" value = "yes" onchange="showWashStation1()" <?php if($hand_washing_stn=='yes'){echo $chk;} ?> />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "washStation" id = "no" value = "no" onchange="showWashStation2()" <?php if($hand_washing_stn=='no'){echo $chk;} ?> />No</label>														
