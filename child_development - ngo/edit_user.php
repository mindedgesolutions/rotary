...
$sql = "Update tbl_admin set username = '$user_name',password = '$user_password',firstname = '$first_name',lastname = '$last_name',
email = '$user_email',create_date = '$create_date' where id = '$uid'";
$ans = mysql_query($sql);
if($ans){
