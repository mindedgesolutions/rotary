...
$query2=mysql_query("SELECT * from rihf_content where text_heading='CORRECTIVE SURGERIES' limit 0,1");
	...
	<?php       
	 ...
	 ?>
        ...
        <td align="left" valign="top" class="text"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" valign="top"><span class="heading1">CORRECTIVE</span> <span class="heading2">SURGERIES</span><br /><br /><table width="697" border="0" cellspacing="0" cellpadding="0">
  <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="success_stories.php?type=Corrective Surgeries" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','images/successa.png',1)"><img src="images/success.png" name="Image17" width="171" height="48" border="0" id="Image17" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
