...
class ProcessPayment {
	...
	function requestMerchant(){
		...
		$postFields .= "&txnid=".rand(0,9999);
		$postFields .= "&date=".$modifiedDate;
		$postFields .= "&custacc=".$_POST['AccountNo'];
		$postFields .= "&ru=".$_POST['ru'];
		
		$postFields .= "&udf1=".$_POST['first_name'] .' '. $_POST['last_name'];
		$postFields .= "&udf2=".$_POST['email'];
		$postFields .= "&udf3=".$_POST['mobile'];
		$postFields .= "&udf4=".$_POST['address'];
