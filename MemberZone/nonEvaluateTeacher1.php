...
$insertqry = "INSERT INTO nonevaluatedteacher (district,club,personname,mobile,email,schoolname,schooladdress, teachername,gender,aboutteacher,teacherimage, submitdt) VALUES ('".$district."','".$club."','".$personname."','".$mobno."','".email."','".schoolname."','".schooladdr."','".$teachername."','".$gender."','".$aboutteacher."','".$newimg."','".date('d-m-Y')."');";
