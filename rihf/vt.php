...
$query2=mysql_query("SELECT * from rihf_content where text_heading='SWAYAM & SAHELI CENTRES' limit 0,1");
	...
	<?php       
	 ...
	 ?>
        ...
        <td align="left" valign="top" class="text"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" valign="top"><span class="heading1">SWAYAM &amp; </span> <span class="heading2">SAHELI CENTRES</span><br /><br />
<table width="400" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><?php if($rec2['text_details']!=""){?><img src="uploads/content/<?php echo $rec2['text_details'];?>" width="706" height="194" /><?php } ?></td>
  </tr>
</table>
</td>
          </tr>
