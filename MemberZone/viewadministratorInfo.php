...
<br /><br />
                                                ...
                                                <span class="auto-style2"><strong>Select a District to view all District Committee member details with photographs.</strong></span>
                                            </td>
                                        </tr>                                        
                                      	<tr>
                                        	<td width="20%">&nbsp;</td>
                                      	...
                                      	<tr>
											...
											Click on <strong>"Upload Your Team Details"</strong> above to upload/add your District Literacy Team details with photographs if not already done.</td>
                                        </tr>                                        
                                      	<tr>
                                        	<td width="20%"><strong>Select District <span style="color:#ff0000">*</span></strong></td>
                                            <td width="2%"><strong>:</strong></td>
                                            <td width="78%">
                                            	<select id="cbodistrict" name="cbodistrict" onchange="showrecord()" >
