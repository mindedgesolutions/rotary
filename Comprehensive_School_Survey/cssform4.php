                                ...
                                <div class="contents">
                                    ...
                                    <div class="table-box">
                                        <table class="table">
                                            ...
                                            <tbody>
	<form class="form-horizontal" name="frm" id="frm" action="ins_school_survey_frm4.php" method="post" enctype="multipart/form-data" >			
                                                <tr>												
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">																												
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "toiletforboys" id = "yes" value = "yes" onchange="showToiletBoys1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "toiletforboys" id = "no" value = "no" onchange="showToiletBoys2()" checked />No</label>
														<br/>
														<table id="idA1" style="display:none;">
															<tr>
																<td>
																	How many are Functional :<input type="text" id="txtBoysFunctional" name="txtBoysFunctional" class="form-control" value="0" maxlength="3" onblur="add1()" required onkeypress="return IsNumeric1(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error1" style="color: Red; display: none">* Input digits (0 - 9)</span>
																	How many are Non Functional :<input type="text" id="txtBoysNonFunctional" name="txtBoysNonFunctional" class="form-control" value="0" maxlength="3" onblur="add1()" required onkeypress="return IsNumeric2(event);" ondrop="return false;" onpaste="return false;" />
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "toiletforgirls" id = "yes" value = "yes" onchange="showToiletGirls1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "toiletforgirls" id = "no" value = "no" onchange="showToiletGirls2()" checked />No</label>													
														<br/>
														<table id="idB1" style="display:none;">
															<tr>
																<td>
																	How many are Functional :<input type="text" id="txtGirlsFunctional" name="txtGirlsFunctional" class="form-control" value="0" maxlength="3" onblur="add2()" required onkeypress="return IsNumeric3(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error3" style="color: Red; display: none">* Input digits (0 - 9)</span>
																	How many are Non Functional :<input type="text" id="txtGirlsNonFunctional" name="txtGirlsNonFunctional" class="form-control" value="0" maxlength="3" onblur="add2()" required onkeypress="return IsNumeric4(event);" ondrop="return false;" onpaste="return false;" />
														...
														<table id="idC1" style="display:none;">
															<tr>
																<td>
																	How many are Functional :<input type="text" id="txtTeacherFunctional" name="txtTeacherFunctional" class="form-control" value="0" maxlength="3" onblur="add3()" required onkeypress="return IsNumeric5(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error5" style="color: Red; display: none">* Input digits (0 - 9)</span>
																	How many are Non Functional :<input type="text" id="txtTeacherNonFunctional" name="txtTeacherNonFunctional" class="form-control" value="0" maxlength="3" onblur="add3()" required onkeypress="return IsNumeric6(event);" ondrop="return false;" onpaste="return false;" />
                                                    ...
                                                    <td class="col-md-8">
														...
														<table id="idWashStation" style="display:none;">
															<tr>
																<td>
																<br/>
																Total Number of Hand Washing Station :<input type="text" id="txtTotalHandWash" name="txtTotalHandWash" class="form-control" value="0" maxlength="3" required onkeypress="return IsNumeric7(event);" ondrop="return false;" onpaste="return false;" />
                                                    ...
                                                    <td class="col-md-8">
														...
														<table id="idlibBooks" style="display:none;">
															<tr>
																<td>
																<br/>
																	Number of Books :<input type="text" id="txtTotalLibBooks" name="txtTotalLibBooks" class="form-control" value="0" maxlength="10" required onkeypress="return IsNumeric8(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">														
														a) Footwear Percentage(%) :<input type="text" id="txtFootwear" name="txtFootwear" class="form-control" value="0" maxlength="2" required onkeypress="return IsNumeric9(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error9" style="color: Red; display: none">* Input digits (0 - 9)</span>
														b) School Bag Percentage(%) :<input type="text" id="txtSchoolBag" name="txtSchoolBag" class="form-control" value="0" maxlength="2" required onkeypress="return IsNumeric10(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error10" style="color: Red; display: none">* Input digits (0 - 9)</span>
														c) Uniform Percentage(%) <input type="text" id="txtUniform" name="txtUniform" class="form-control" value="0" maxlength="2" required onkeypress="return IsNumeric11(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">														
														<input type="text" id="txtTotalBenches" name="txtTotalBenches" class="form-control" value="0" maxlength="5" required onkeypress="return IsNumeric12(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">														
														<input type="text" id="txtTotalDesks" name="txtTotalDesks" class="form-control" value="0" maxlength="5" required onkeypress="return IsNumeric13(event);" ondrop="return false;" onpaste="return false;" />
                                                    ...
                                                    <td class="col-md-8">	
														...
														<table id="idStaffRoom" style="display:none;">
															<tr>
																<td>
																<br/>
																	Number of chairs :<input type="text" id="txtTotalStaffRoomChairs" name="txtTotalStaffRoomChairs" class="form-control" value="0" maxlength="5" required onkeypress="return IsNumeric14(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error14" style="color: Red; display: none">* Input digits (0 - 9)</span>		
																	Number of tables :<input type="text" id="txtTotalStaffRoomTables" name="txtTotalStaffRoomTables" class="form-control" value="0" maxlength="5" required onkeypress="return IsNumeric15(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">	
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "eLearning" id = "yes" value = "yes" onchange="showeLearning1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "eLearning" id = "no" value = "no" onchange="showeLearning2()" checked />No</label>																												
														<table id="ideLearning" style="display:none;">
															<tr>
																<td>
																<br/>
																	how many functional units :<input type="text" id="txteLearning" name="txteLearning" class="form-control" value="0" maxlength="3" required onkeypress="return IsNumeric16(event);" ondrop="return false;" onpaste="return false;" />
