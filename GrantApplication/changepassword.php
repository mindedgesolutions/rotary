                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-bottom:5px">
                                    <tr>
                                        <td align="left" colspan="3">
                                       	  <h1 style="padding:0; margin:0">Change Password</h1>
                                     	</td>
...
<table border="0" cellpadding="5" cellspacing="0" width="70%" align="center" style="text-align:left; color:#666666; font-family:Arial, Helvetica, sans-serif; font-size:12px; background:#f5f5f5; box-shadow:0 0 1px #999999;">
	<tr>
		<td class="hed1">Change Password</td>
  	</tr>
</table>
    ...
    <tr>
        <td>
            <p style="padding:15px 15px 0 15px; margin:0"><span style="color:#FF0000; font-size:14px; font-weight:bold"><?php echo $msg;?></span>
               ...
               <tr>
                    <td width="30%" style="background:url(images/user.png) left center no-repeat; padding:0 0 0 20px"><strong>Old Password <span style="color:#ff0000">*</span></strong></td>
                    <td width="4%"><strong>:</strong></td>
                    <td width="66%"><input type="password" id="txtoldpwd" name="txtoldpwd" style="width:100%"/></td>
                </tr><tr>
                    <td width="30%" style="background:url(images/user.png) left center no-repeat; padding:0 0 0 20px"><strong>New Password  <span style="color:#ff0000">*</span></strong></td>
                    <td width="4%"><strong>:</strong></td>
                    <td width="66%"><input type="password" id="txtnewpwd" name="txtnewpwd" style="width:100%"/></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td>
                        <input type="button" name="btn_submit" id="btn_submit" value="Change Password"  class="hed" style="cursor:pointer; border-radius:3px;" onclick="goforpassword();" /> 
...
function goforpassword(){
	...
	if($.trim($('#txtnewpwd').val())=='')
	{
		...
		var pars = 'email='+$("#txtemail").val()+'&refappno='+$("#hdnrefno").val()+'&district='+$("#hdnDistrict").val()+'&club='+$("#hdnClub").val()+'&oldpwd='+$('#txtoldpwd').val()+'&newpwd='+$('#txtnewpwd').val()
	//	alert(pars)
			$.ajax({                                      
			  url: 'getnewpassword.php',                     
			  data: pars,
			  type:"post",
				dataType: 'json',
