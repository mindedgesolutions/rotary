...
function validateExt(){
	...
	if($.inArray(ext, ['jpg','png','pdf']) == -1){
    	...
    	alert('Invalid extension (.jpg, .png and .pdf files only)');
...
<script>
																	...
																	<script>
																		...
																		function sumit() {
																			document.getElementById("frm").action='ins_school_survey_maharashtra_gov.php?q=1';
	...
	else if(document.getElementById('schoolTypeGirls').checked)
	{
		...
		else if(document.getElementById("eLearning_yes").checked)
		{
			...
			if(okay)
			{
				...
				{
					if (confirm("Once you press OK you are unable to edit again") == true) {
...
<div id="sumitone">                                      
										<table class="table">
                                            ...
                                            <tbody>		
	<form class="form-horizontal" name="frm" id="frm" action="ins_school_survey_maharashtra_gov.php" method="POST" enctype="multipart/form-data" >	
								<tr>
				...
				<center>
					...
					<h5 class="heading">General Information</h5>
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<input type="text" id="txtSchoolName" name="txtSchoolName" class="form-control" onkeyup="nospecial(this)">
													</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-md-8">
														<input type="text" id="txtudiseno" name="txtudiseno" maxlength="11" class="form-control" required onkeypress="return IsNumeric201(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<input type="text" id="txtSchoolHead" name="txtSchoolHead" class="form-control" onkeyup="nospecial(this)">
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Phone Number :</td>
                                                    <td class="col-md-8">
														<input class="form-control" type="text" id="txtSchoolPhoneNo" name="txtSchoolPhoneNo" maxlength="10" required onkeypress="return IsNumeric2(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8"> <!-- onblur="checkEmail1(this.value)" -->
                                                     <input class="form-control" type="text" id="txtSchoolEmailID" name="txtSchoolEmailID" >
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtSchoolState" name="txtSchoolState" value="Maharashtra" >  
                                                    </td>
                                                </tr>
												<!-- new-->
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtDistrict" name="txtDistrict" onkeyup="nospecial(this)" >  
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Tehsil :</td>
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtTehsil" name="txtTehsil" onkeyup="nospecial(this)" >  
                                                    </td>
                                                </tr>
												<!-- new-->
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtSchoolVillage" name="txtSchoolVillage" onkeyup="nospecial(this)" >  
                                                    </td>
                                                </tr>
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtSchoolPin" name="txtSchoolPin" maxlength="6" required onkeypress="return IsNumeric3(event);" ondrop="return false;" onpaste="return false;" />
		...
		<tr>
                                                    ...
                                                    <td class="col-md-8">
														<label class="radio-inline" for = "Girls"><input type = "radio" name = "schooltype" id = "schoolTypeGirls" onchange="schoolType1()" value = "Girls" />Girls</label>&nbsp;&nbsp;&nbsp;&nbsp;
														<label class="radio-inline" for = "Boys"><input type = "radio" name = "schooltype" id = "schoolTypeBoys" onchange="schoolType2()" value = "Boys" />Boys</label>
														<label class="radio-inline" for = "Co-Educational"><input type = "radio" name = "schooltype" id = "schoolTypeCoEdu" onchange="schoolType3()" value = "Co-Educational"  />Co-Educational</label>
			...
			<tr>												
                                                    ...
                                                    <td class="col-md-8">
														<label id="girl">Girls:</label><input type="text" id="txtNoOfGirls" name="txtNoOfGirls" class="form-control" value="0" maxlength="3" onblur="add1()" required onkeypress="return IsNumeric15(event);" ondrop="return false;" onpaste="return false;" />
														<span id="error15" style="color: Red; display: none">* Input digits (0 - 9)</span>
														<label id="boy">Boys:</label><input type="text" id="txtNoOfBoys" name="txtNoOfBoys" class="form-control" value="0" maxlength="3" onblur="add1()" required onkeypress="return IsNumeric16(event);" ondrop="return false;" onpaste="return false;" />
														<span id="error16" style="color: Red; display: none">* Input digits (0 - 9)</span>
														<label id="boygirltotal">Total:</label><input type="text" id="txtTotalStudent" value="0" name="txtTotalStudent" class="form-control" readonly>
			...
			<!-- onclick="showMaleTeacherNotAval(this)" -->
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">
														Male:&nbsp; ( If Not Available&nbsp;&nbsp; <input type="checkbox" name="not_aval_male_teacher" id="not_aval_male_teacher" value="0" onclick="showMaleTeacherNotAval(this)"> )
														<input type="text" id="txtMale" name="txtMale" class="form-control" value="0" maxlength="3" onblur="add2()" required onkeypress="return IsNumeric17(event);" ondrop="return false;" onpaste="return false;" />
														<span id="error17" style="color: Red; display: none">* Input digits (0 - 9)</span>
														Female:&nbsp; ( If Not Available&nbsp;&nbsp; <input type="checkbox" name="not_aval_female_teacher" id="not_aval_female_teacher" value="0" onclick="showFemaleTeacherNotAval(this)" > )										
														<input type="text" id="txtFemale" name="txtFemale" class="form-control" value="0" maxlength="3" onblur="add2()" required onkeypress="return IsNumeric4(event);" ondrop="return false;" onpaste="return false;" />
                                                ...
                                                <tr style="display:none;">												
                                                    ...
                                                    <td class="col-md-8">
														...
														<input type="text" id="txtTrainedMaleTeacher" name="txtTrainedMaleTeacher" class="form-control" value="0" maxlength="3" onblur="add3()" required onkeypress="return IsNumeric5(event);" ondrop="return false;" onpaste="return false;" />
														...
														<input type="text" id="txtTrainedFemaleTeacher" name="txtTrainedFemaleTeacher" class="form-control" value="0" maxlength="3" onblur="add3()" required onkeypress="return IsNumeric6(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr style="display:none;">												
                                                    ...
                                                    <td class="col-md-8">														
														...
														<input type="text" id="txtNoDisabilityMale" name="txtNoDisabilityMale" class="form-control" value="0" maxlength="3" onblur="add4()" required onkeypress="return IsNumeric7(event);" ondrop="return false;" onpaste="return false;" />
														...
														<input type="text" id="txtNoDisabilityFemale" name="txtNoDisabilityFemale" class="form-control" value="0" maxlength="3" onblur="add4()" required onkeypress="return IsNumeric8(event);" ondrop="return false;" onpaste="return false;" />
														<span id="error8" style="color: Red; display: none">* Input digits (0 - 9)</span>
														
														<label id="malefemaletotal">Total:</label><input type="text" id="txtTotalDisability" name="txtTotalDisability" class="form-control" readonly>
										...
										<h5 class="heading">School Infrastructure Details</h5>
											...
											<tr>												
															...
															<strong><u>School Building Structure</u></strong><br>
																<table style="border:1px solid black; color:#000000">
																	<tr style="border:1px solid black; color:#000000">
																		<td style="border:1px solid black; color:#000000"><center><b>Particulars</b></center></td>
                                                    ...
                                                    <td class="col-md-8">
														...
														<label class="radio-inline" for = "Good"><input type = "radio" name = "schoolBuildStr" id = "Good" value = "Good" checked />Good</label>
														<label class="radio-inline" for = "Average"><input type = "radio" name = "schoolBuildStr" id = "Average" value = "Average" />Average</label>
														<label class="radio-inline" for = "Poor "><input type = "radio" name = "schoolBuildStr" id = "Poor" value = "Poor" />Poor</label>
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">
														<label class="radio-inline" for = "Constant"><input type = "radio" name = "statusEleSup" id = "Constant" value = "Constant" checked />Constant</label>
														<label class="radio-inline" for = "Intermittent"><input type = "radio" name = "statusEleSup" id = "Intermittent" value = "Intermittent" />Intermittent</label>
														<label class="radio-inline" for = "Non-existent"><input type = "radio" name = "statusEleSup" id = "Non-existent" value = "Non-existent" />Non-existent</label>
													</td>
                                                </tr>
                                                <tr style="display:none;">												
                                                    ...
                                                    <td class="col-md-8">
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "buildSecure" id = "yes" value = "yes" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "buildSecure" id = "no" value = "no" checked />No</label>
													</td>
                                                </tr>
												<tr style="display:none;">												
                                                    ...
                                                    <td class="col-md-8">																												
														...
														-->
														<br/>
														<table id="idA11" style="display:none;">
															<tr>
																<td>
																	How many are Functional :<input type="text" id="txtBoysFunctional" name="txtBoysFunctional" class="form-control" value="0" maxlength="3" onblur="add10()" required onkeypress="return IsNumeric19(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error19" style="color: Red; display: none">* Input digits (0 - 9)</span>
																	How many are Non Functional :<input type="text" id="txtBoysNonFunctional" name="txtBoysNonFunctional" class="form-control" value="0" maxlength="3" onblur="add10()" required onkeypress="return IsNumeric20(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error20" style="color: Red; display: none">* Input digits (0 - 9)</span>
																	Total:<input type="text" id="txtTotalBoys" name="txtTotalBoys" class="form-control" readonly>	
														...
														-->
														<br/>
														<table id="idB11" style="display:none;">
															<tr>
																<td>
																	How many are Functional :<input type="text" id="txtGirlsFunctional" name="txtGirlsFunctional" class="form-control" value="0" maxlength="3" onblur="add20()" required onkeypress="return IsNumeric21(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error21" style="color: Red; display: none">* Input digits (0 - 9)</span>
																	How many are Non Functional :<input type="text" id="txtGirlsNonFunctional" name="txtGirlsNonFunctional" class="form-control" value="0" maxlength="3" onblur="add20()" required onkeypress="return IsNumeric22(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error22" style="color: Red; display: none">* Input digits (0 - 9)</span>
																	Total:<input type="text" id="txtTotalGirls" name="txtTotalGirls" class="form-control" readonly>	
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "toiletforteacher" id = "yes" value = "yes" onchange="showToiletTeacher1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "toiletforteacher" id = "no" value = "no" onchange="showToiletTeacher2()" checked />No</label>	
														<table id="idC11" style="display:none;">
															<tr>
																<td>
																	How many are Functional :<input type="text" id="txtTeacherFunctional" name="txtTeacherFunctional" class="form-control" value="0" maxlength="3" onblur="add30()" required onkeypress="return IsNumeric23(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error23" style="color: Red; display: none">* Input digits (0 - 9)</span>
																	How many are Non Functional :<input type="text" id="txtTeacherNonFunctional" name="txtTeacherNonFunctional" class="form-control" value="0" maxlength="3" onblur="add30()" required onkeypress="return IsNumeric24(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error24" style="color: Red; display: none">* Input digits (0 - 9)</span>
																	Total:<input type="text" id="txtTotalTeachers" name="txtTotalTeachers" class="form-control" readonly>	
												...
												<tr style="display:none;">
                                                    ...
                                                    <td class="col-md-8">
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "drinkWater" id = "yes" value = "yes" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "drinkWater" id = "no" value = "no" checked />No</label>														
                                                    </td>
                                                </tr>
												...
												<tr style="display:none;">
                                                    ...
                                                    <td class="col-md-8">
														<label class="radio-inline" for = "yes"><input type = "radio" name = "washStation" id = "yes" value = "yes" onchange="showWashStation1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "washStation" id = "no" value = "no" onchange="showWashStation2()" checked />No</label>														
														
														<table id="idWashStation" style="display:none;">
															<tr>
																<td>
																<br/>
																Total Number of Hand Washing Station :<input type="text" id="txtTotalHandWash" name="txtTotalHandWash" class="form-control" value="0" maxlength="3" required onkeypress="return IsNumeric25(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr style="display:none;">
                                                    ...
                                                    <td class="col-md-8">
														<label class="radio-inline" for = "yes"><input type = "radio" name = "libBooks" id = "yes" value = "yes" onchange="showLibBooks1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "libBooks" id = "no" value = "no" onchange="showLibBooks2()" checked />No</label>														
														
														<table id="idlibBooks" style="display:none;">
															<tr>
																<td>
																<br/>
																	Number of Books :<input type="text" id="txtTotalLibBooks" name="txtTotalLibBooks" class="form-control" value="0" maxlength="10" required onkeypress="return IsNumeric26(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr style="display:none;">												
                                                    ...
                                                    <td class="col-md-8">														
														a) Footwear Percentage(%) :<input type="text" id="txtFootwear" name="txtFootwear" class="form-control" value="0" maxlength="3" required onkeypress="return IsNumeric27(event);" ondrop="return false;" onpaste="return false;" onchange="percentChk1(this.value)" />
																	<span id="error27" style="color: Red; display: none">* Input digits (0 - 9)</span>
														b) School Bag Percentage(%) :<input type="text" id="txtSchoolBag" name="txtSchoolBag" class="form-control" value="0" maxlength="3" required onkeypress="return IsNumeric28(event);" ondrop="return false;" onpaste="return false;" onchange="percentChk2(this.value)" />
																	<span id="error28" style="color: Red; display: none">* Input digits (0 - 9)</span>
														c) Uniform Percentage(%) <input type="text" id="txtUniform" name="txtUniform" class="form-control" value="0" maxlength="3" required onkeypress="return IsNumeric29(event);" ondrop="return false;" onpaste="return false;" onchange="percentChk3(this.value)"/>
												...
												<tr style="display:none;">
                                                    ...
                                                    <td class="col-md-8">
														<label class="radio-inline" for = "yes"><input type = "radio" name = "avai_benches" id = "yes" value = "yes" onchange="showBenches1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "avai_benches" id = "no" value = "no" onchange="showBenches2()" checked />No</label>														
														
														<table id="idAviBanches" style="display:none;">
															<tr>
																<td>
																<br/>
																	Number of benches available in the school :<input type="text" id="txtTotalBenches" name="txtTotalBenches" class="form-control" value="0" maxlength="5" required onkeypress="return IsNumeric30(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr style="display:none;">
                                                    ...
                                                    <td class="col-md-8">
														<label class="radio-inline" for = "yes"><input type = "radio" name = "avai_desks" id = "yes" value = "yes" onchange="showDesks1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "avai_desks" id = "no" value = "no" onchange="showDesks2()" checked />No</label>														
														
														<table id="idAviDesks" style="display:none;">
															<tr>
																<td>
																<br/>
																	Number of desks available in the school :<input type="text" id="txtTotalDesks" name="txtTotalDesks" class="form-control" value="0" maxlength="5" required onkeypress="return IsNumeric31(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr style="display:none;">												
                                                    ...
                                                    <td class="col-md-8">	
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "headTeacher" id = "yes" value = "yes"  />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "headTeacher" id = "no" value = "no" checked />No</label>																												
														<!--
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "stores" id = "yes" value = "yes"  />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "stores" id = "no" value = "no" checked />No</label>																												
														<!--
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "laboratory" id = "yes" value = "yes"  />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "laboratory" id = "no" value = "no"  checked />No</label>																												
														<!--
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "kitchen" id = "yes" value = "yes" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "kitchen" id = "no" value = "no"  checked />No</label>																												
														<!--
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "IndoorGames" id = "yes" value = "yes"  />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "IndoorGames" id = "no" value = "no"  checked />No</label>																												
														<!--
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "StaffRoom" id = "yes" value = "yes" onchange="showStaffRoom1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "StaffRoom" id = "no" value = "no" onchange="showStaffRoom2()" checked />No</label>																												
														<table id="idStaffRoom" style="display:none;">
															<tr>
																<td>
																<br/>
																	Number of chairs :<input type="text" id="txtTotalStaffRoomChairs" name="txtTotalStaffRoomChairs" class="form-control" value="0" maxlength="5" required onkeypress="return IsNumeric32(event);" ondrop="return false;" onpaste="return false;" />
																	<span id="error32" style="color: Red; display: none">* Input digits (0 - 9)</span>		
																	Number of tables :<input type="text" id="txtTotalStaffRoomTables" name="txtTotalStaffRoomTables" class="form-control" value="0" maxlength="5" required onkeypress="return IsNumeric33(event);" ondrop="return false;" onpaste="return false;" />
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">	
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "eLearning" id = "eLearning_yes" value = "yes" onchange="showeLearning1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "eLearning" id = "eLearning_no" value = "no" onchange="showeLearning2()" checked />No</label>																												
														<table id="ideLearning" style="display:none;">
															...
															<tr>
																<td style="width:50%"><input type="checkbox" name="chkELearn[]" value="Television" >&nbsp;Television</td>
																<td style="width:50%"><input type="checkbox" name="chkELearn[]" value="Projector with ceiling mount" >&nbsp;Projector with ceiling mount</td>
																
															</tr>
															<tr>
																<td><input type="checkbox" name="chkELearn[]" value="Integrated projector" >&nbsp;Integrated projector</td>
																<td><input type="checkbox" name="chkELearn[]" value="Integrated white boards" >&nbsp;Integrated white boards</td>
															</tr>
															<tr>
																<td><input type="checkbox" name="chkELearn[]" value="Tablets" >&nbsp;Tablets</td>
																<td><input type="checkbox" name="chkELearn[]" id="chkELearnOther" onclick="showELearn(this)" value="Others" >&nbsp;Others
																</td>
															</tr>
															...
															<tr>
																<td>
																	<table id="idELearnOther" style="display:none;">
																		<tr>
																			<td colspan="2">
																				Other :<input type="text" id="txtELearnOther" name="txtELearnOther" class="form-control" >	
																			</td>
																		</tr>
																	</table>
																</td>
															...
															<tr>
																<td>
																<br/>
																	how many functional units :<input type="text" id="txteLearning" name="txteLearning" class="form-control" value="0" maxlength="3" required onkeypress="return IsNumeric34(event);" ondrop="return false;" onpaste="return false;" />
															...
															<tr>
																<td>
																<br/>
																	When was e-learning facility installed :<input type="text" id="txteLearningWhen" name="txteLearningWhen" class="form-control" onkeypress="return restrictCharacters(event);" readonly   />
																</td>
															</tr>

															<tr>
																<td>
																	<br/>Upload supporting document : <br/>
																	<input type="file" name="file1" id="file1" onchange="validateExt()" required>
																</td>
															</tr>
															<tr>
																<td>
																<br/>
																	What does an e-learning unit comprise of :<input type="text" id="txteLearningComprise" name="txteLearningComprise" class="form-control"  />
																</td>
															</tr>
															<tr style="display:none;">
																<td>
																<br/>
																	Date of installation :<input type="text" id="txteLearningDtInstallation" name="txteLearningDtInstallation" class="form-control"  />
																</td>
															</tr>
															<!-- New -->
										...
										<h5 class="heading">Status of Physical Education</h5>
												...
												<tr style="display:none;">												
                                                    ...
                                                    <td class="col-md-8">
														<table>
															<tr>
																<td style="width:25%;"><label class="radio-inline" for = "None"><input type = "radio" name = "peTeacher" id = "NonePE" value = "None" onchange="showOther5()" checked />None</label></td>
																<td style="width:25%;"><label class="radio-inline" for = "One"><input type = "radio" name = "peTeacher" id = "OnePE" value = "One" onchange="showOther6()" />One</label></td>
																<td style="width:25%;"><label class="radio-inline" for = "onetwo"><input type = "radio" name = "peTeacher" id = "onetwoPE" value = "1 - 2" onchange="showOther6()" />1 - 2</label></td>
																<td style="width:25%;"><label class="radio-inline" for = "Other"><input type = "radio" name = "peTeacher" id = "OtherPE" value = "Other" onchange="showOther7()" />Other</label></td>
															</tr>
														</table>
                                                ...
                                                <tr id="peTeacherID11111" style="display:none;">	
													<!-- New -->
													<td class="col-md-4">
														<label id="peTeacherID1" >Please mention how many on rolls/Contractual :</label>
													</td>
													<td class="col-md-8" >
														<input type="text" id="peTeacherID2" name="peTeacherID2" class="form-control" >	
													</td>
													<!-- New -->
															<!--
												...
												<tr id="peTeacherID_is" style="display:none;">	
													...
													<td class="col-md-8" >
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "peSports_is" id = "yes" value = "yes" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "peSports_is" id = "no" value = "no" checked />No</label>
												...
												<tr style="display:none;">
                                                    ...
                                                    <td class="col-md-8">
														<label class="radio-inline" for = "yes"><input type = "radio" name = "peSports_curr" id = "yes" value = "yes" onchange="showPescribed1()" />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "peSports_curr" id = "no" value = "no" onchange="showPescribed2()" checked />No</label>
															...
															<tr>
																<td>
																	<table id="idSportsInfraOther" style="display:none;">
																		<tr>
																			<td colspan="2">
																				Other :<input type="text" id="txtSportsInfraOther2" name="txtSportsInfraOther2" class="form-control" >	
																			</td>
																		</tr>
																	</table>
																</td>
												...
												<tr style="display:none;">
                                                    ...
                                                    <td class="col-md-8">
														<table id="idPeSports">
															<tr>
																<td style="width:35%;">
																	<label class="radio-inline" for = "yes"><input type = "radio" name = "peSports" id = "yes" value = "yes" checked />Yes</label>															
																</td>
																<td style="width:35%;">
																	<label class="radio-inline" for = "no"><input type = "radio" name = "peSports" id = "no" value = "no"  />No</label>														
																</td>
																<td style="width:30%;">
												...
												<tr style="display:none;">
                                                    ...
                                                    <td class="col-md-8">
														<table id="idPeSports">
															<tr>
																<td style="width:50%;">
																	<label class="radio-inline" for = "yes"><input type = "radio" name = "peSportsCard" id = "yes" value = "yes" checked />Yes</label>															
																</td>
																<td style="width:50%;">
																	<label class="radio-inline" for = "no"><input type = "radio" name = "peSportsCard" id = "no" value = "no"  />No</label>														
																</td>
                                                    ...
                                                    <td class="col-md-8">
														<table id="idPeSports">
															<tr>
																...
																<td width="30%">
																	<label class="radio-inline" for = "yes"><input type = "radio" name = "interSchool" id = "yes" value = "yes" checked />Yes</label>															
																</td>
																<td width="30%">
																	<label class="radio-inline" for = "no"><input type = "radio" name = "interSchool" id = "no" value = "no"  />No</label>														
																</td>
															</tr>
															...
															<tr>
																...
																<td>
																	<label class="radio-inline" for = "yes"><input type = "radio" name = "districtLevel" id = "yes" value = "yes" checked />Yes</label>															
																</td>
																<td>
																	<label class="radio-inline" for = "no"><input type = "radio" name = "districtLevel" id = "no" value = "no"  />No</label>														
																</td>
															</tr>
															...
															<tr>
																...
																<td>
																	<label class="radio-inline" for = "yes"><input type = "radio" name = "stateLevel" id = "yes" value = "yes" checked />Yes</label>															
																</td>
																<td>
																	<label class="radio-inline" for = "no"><input type = "radio" name = "stateLevel" id = "no" value = "no"  />No</label>														
																</td>
															</tr>
															...
															<tr>
																...
																<td>
																	<label class="radio-inline" for = "yes"><input type = "radio" name = "nationalLevel" id = "yes" value = "yes" checked />Yes</label>															
																</td>
																<td>
																	<label class="radio-inline" for = "no"><input type = "radio" name = "nationalLevel" id = "no" value = "no"  />No</label>														
																</td>
															</tr>
															...
															<tr>
																...
																<td>
																	<label class="radio-inline" for = "yes"><input type = "radio" name = "internationalLevel" id = "yes" value = "yes" checked />Yes</label>															
																</td>
																<td>
																	<label class="radio-inline" for = "no"><input type = "radio" name = "internationalLevel" id = "no" value = "no"  />No</label>														
																</td>
															</tr>
														</table>
                                                    </td>
												...
												<tr style="display:none;">
                                                    ...
                                                    <td class="col-md-8">
														1. <input type="text" id="txtPopularSports1" name="txtPopularSports1" class="form-control" >
														2. <input type="text" id="txtPopularSports2" name="txtPopularSports2" class="form-control" >
														3. <input type="text" id="txtPopularSports3" name="txtPopularSports3" class="form-control" >
                                                    </td>
                                                </tr>
												<tr style="display:none;">
                                                    ...
                                                    <td class="col-md-8">
														<table>
															<tr>
																<td width="25%">
																	<label class="radio-inline" for = "yes"><input type = "radio" name = "peSportsOpinion" id = "yes" value = "yes" checked onchange="showSportsOpinion1()" />Yes</label>
																</td>
																<td width="10%">Why</td>
																<td width="65%">
																	<input type="text" width="100%" id="txtSportsOpinion1" name="txtSportsOpinion1" class="form-control" >
																</td>
															</tr>
															
															<tr>
																<td width="25%">
																	<label class="radio-inline" for = "no"><input type = "radio" name = "peSportsOpinion" id = "no" value = "no" onchange="showSportsOpinion2()"  />No</label>
																</td>
																<td width="10%">Why</td>
																<td width="65%">
																	<input type="text" width="100%" id="txtSportsOpinion2" name="txtSportsOpinion12" class="form-control" readonly >
																</td>
															</tr>															
														</table>
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<textarea class="form-control" rows="5" id="otherInfo" name="otherInfo" onkeyup="nospecial(this)" ></textarea>
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Name of the person submitting this form</td>
                                                    <td class="col-md-8">
														<input type="text" id="txtNameOfPerson" name="txtNameOfPerson" class="form-control" required onkeyup="nospecial(this)" >
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Designation of the person submitting this form</td>
                                                    <td class="col-md-8">
														<input type="text" id="txtDesigOfPerson" name="txtDesigOfPerson" class="form-control" required onkeyup="nospecial(this)" >
                                                    </td>
                                                </tr>
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                        <div class="form-group has-error">
															...
															<button type="button" class="btn btn-primary"  onclick=sumit();>Submit</button>
															<button type="button" class="btn btn-primary"  onclick="finalSubmission();">Final Submission</button>
                                                        </div>
                                                    </td>
                                                </tr>
