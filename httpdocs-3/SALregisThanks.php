                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-bottom:5px">
                                    <tr>
                                        <td align="left" colspan="3">
                                       	  <h1 style="padding:0; margin:0">South Asia Literacy Summit</h1>
                                        </td>
...
<table border="0" cellpadding="5" cellspacing="0" width="100%" align="center" style="text-align: center; color:#333333; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:30px; font-weight: bold">
	<tr>
    	<td>
        	<img src="images/thankyou.jpg" width="120" style="margin-bottom:15px" /><br />
            <h1 style="color:#333333; font-size:24px">Thank You for Registration.</h1>
            <h1 style="color:#333333; font-size:24px">Your Registration ID is <font color="#0066FF"><?php echo $_GET["regisno"];?></font></h1>
        </td>
    </tr>
</table>
