...
function finalSubmission()
{
	...
	else if(document.getElementById('inp_toilet_for_boys_yes').checked)
	{
		var cnt=0;
		//document.getElementById("idA11").style.display="block";
		//txtBoysFunctional,txtBoysNonFunctional,txtTotalBoys
		if(document.getElementById("txtBoysFunctional").value=="0")
		{
			cnt=1;
			alert("How many are Functional Toilet for Boys");
			document.getElementById("txtBoysFunctional").focus();
			return false;
		}
		if(document.getElementById("txtBoysNonFunctional").value=="0")
		{
			cnt=1
			alert("How many are Non Functional Toilet for Boys");
			document.getElementById("txtBoysNonFunctional").focus();
			return false;
		}
		if(document.getElementById('inp_toilet_for_girls_yes').checked)
		{
			if(document.getElementById("txtGirlsFunctional").value=="0")
			{
				cnt=1;
				alert("How many are Functional Toilet for Girls");
				document.getElementById("txtGirlsFunctional").focus();
				return false;
			}
			if(document.getElementById("txtGirlsNonFunctional").value=="0")
			{
				cnt=1
				alert("How many are Non Functional Toilet for Girls");
				document.getElementById("txtGirlsNonFunctional").focus();
				return false;
			}
		}
		
		if(document.getElementById('toiletforteacher_yes').checked)
		{
			if(document.getElementById("txtTeacherFunctional").value=="0")
			{
				cnt=1;
				alert("How many are Functional Toilet for Teacher");
				document.getElementById("txtTeacherFunctional").focus();
				return false;
			}
			if(document.getElementById("txtTeacherNonFunctional").value=="0")
			{
				cnt=1
				alert("How many are Non Functional Toilet for Teacher");
				document.getElementById("txtTeacherNonFunctional").focus();
				return false;
			}
		}
		if(document.getElementById('schoolTypeGirls').checked)
		{
			if(document.getElementById("txtNoOfGirls").value=="0")
			{
				cnt=1;
		...
		if(document.getElementById('schoolTypeBoys').checked)
		{
			if(document.getElementById("txtNoOfBoys").value=="0")
			{
				cnt=1;
		...
		if(document.getElementById('schoolTypeCoEdu').checked)
		{
			if(document.getElementById("txtNoOfGirls").value=="0")
			{
				cnt=1;
		...
		if(document.getElementById('washStation_yes').checked)
		{
			
			if(document.getElementById("txtTotalHandWash").value=="0")
			{
				cnt=1;
				alert("Enter Total Number of Hand Washing Station ");
				document.getElementById("txtTotalHandWash").focus();
				return false;
			}
		}
		...
		<?php
			...
			?>	
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<input type="text" id="txtSchoolName" name="txtSchoolName" class="form-control" value="<?php echo $school_name; ?>" >
													</td>
                                                </tr>
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<input type="text" id="txtSchoolHead" name="txtSchoolHead" class="form-control" value="<?php echo $head_teacher_name; ?>" >
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Phone Number :</td>
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtTehsil" name="txtTehsil" value="<?php echo $school_tehsil; ?>"  >  
                                                    </td>
                                                </tr>
												<!-- new-->
												<tr>
                                                    ...
                                                    <td class="col-md-8">
                                                     <input class="form-control" type="text" id="txtSchoolVillage" name="txtSchoolVillage" value="<?php echo $village; ?>" >  
                                                    </td>
                                                </tr>
											...
											<tr>												
												...
												<tr>												
                                                    ...
                                                    <td class="col-md-8">	
														...
														<label class="radio-inline" for = "yes"><input type = "radio" name = "eLearning" id = "yes" value = "yes" onchange="showeLearning1()" <?php if($e_learning_fac=='yes'){echo $chk;} ?> />Yes</label>
														<label class="radio-inline" for = "no"><input type = "radio" name = "eLearning" id = "no" value = "no" onchange="showeLearning2()" <?php if($e_learning_fac=='no'){echo $chk;} ?>  />No</label>																												
														<table id="ideLearning" style="display:none;">
															...
															<tr>
																<td>
																<br/>
																	When was e-learning facility installed :<input type="text" id="txteLearningWhen" name="txteLearningWhen" class="form-control" value="<?php echo $e_learning_facility_installed; ?>" onkeypress="return restrictCharacters(event);" />
																</td>
															</tr>
															<tr>
																<td>
									...
									<center>
										...
										<h5 class="heading">Status of Physical Education</h5>
												...
												<tr>
                                                    ...
                                                    <td class="col-md-8">
														<textarea class="form-control" rows="5" id="otherInfo" name="otherInfo" ><?php echo $any_other_info_not_covered; ?></textarea>
                                                    </td>
                                                </tr>
												<tr>
                                                    <td class="col-md-4">Name and designation of the person submitting this form</td>
                                                    <td class="col-md-8">
														<input type="text" id="txtNameDesig" name="txtNameDesig" class="form-control" value="<?php echo $name_desig_who_fill_form; ?>" >
                                                    </td>
                                                </tr>
								<?php } ?>	
												<tr>
