...
if (strlen($donar_email)>0)
{
 ...
 $sql=$sql . " order by first_name,donar_email,donar_contact";
...
<script>
  ...
  alert("Click, new value = " + cb.checked);
}
function tst() {
         alert('444');
}
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Donor record update</li>
  </ol>
</section>
<!-- Main content -->
 <section class="content">
 <!-- Small boxes (Stat box) -->
 <form role="form" action="master_donar_merge.php" method="post" enctype="multipart/form-data">
 <div class="box-body">
     <?php echo $msg; ?>
     <fieldset>
...
<form role="form" action="master_donar_merge_next.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
	  ...
	  ?>
	         <tr>
	    <td><input name="checkbox[]" type="checkbox" value="<?php echo $donar_id; ?>"></td>
	...
	?>
     ...
     <?php echo $pagingLink; ?>
             ...
             <div class="col-sm-6">
                         <label>Merge with record no (e,g, 2)</label>
                          <input type="number" class="form-control" name="txtRecord" id="txtRecord" required />
              </div>
