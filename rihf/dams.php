...
$query2=mysql_query("SELECT * from rihf_content where text_heading='CHECK DAMS' limit 0,1");
	...
	<?php       
	 ...
	 ?>
        ...
        <td align="left" valign="top" class="text"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" valign="top"><span class="heading1">CHECK </span> <span class="heading2">DAMS</span><br /><br /><table width="697" border="0" cellspacing="0" cellpadding="0">
  <tr>
