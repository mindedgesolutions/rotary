		...
		<div class="right-sec"> 
			<header> 
			  <?php include('include/child_header.php'); ?>
				<div>
					<h1 style="color:#ffffff; text-align:center;">Add New NGO/Center</h1>
					<font color="#F4F3F3" style="float:right;">Master -> NGO/Center ->Add New</font>
				</div>
			  <div class="clearfix"></div>
			</header>
			...
			?>
				<form name="frm" id="frm" action="ngocentersave.php" method="post" enctype="multipart/form-data"> 
					<div class="row">
						...
						<div class="col-sm-2"></div>
							<div class="col-sm-8" style="border : 1px solid #303238;margin-top : 0px;">
								<div class="form-group" style="padding-bottom:75px;">
										<div class="col-sm-12">
											<b>Type:</b><select class="form-control" id="selType" name="selType" onchange="showDiv(this)">
										...
										<div id="divNGO" name="divNGO" class="col-sm-12">
											...
											<label id="lblNGO1" name="lblNGO1" for="exampleInputFile" style="display:none;">Name of the NGO:</label>
