    ...
    <div class="right-sec"> 
	  ...
	  <div class="row">
			<div class="col-xs-12">
				...
				<h6 style="color:#ffffff; text-align:center;"><i>Register/Login to see the performance of the child you sponsored!</i></h6>
     ...
     <fieldset>
	  ...
	  ?>
        ...
        <td><p style="color:#0d9429;"><a href='register.php?id=<?php echo $donar_id; ?>&fn=<?php echo $first_name; ?>&ln=<?php echo $last_name; ?>&eml=<?php echo $donar_email; ?>'><b>Register</b></a></p></td>
          <td><p style="color:#0d9429;"><a href='index.php?id=<?php echo $donar_id; ?>'><b>Login</b></a></p></td>
        </tr>
             <?php
	}
	?>
