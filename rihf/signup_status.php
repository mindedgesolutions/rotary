...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  {
  ?>
  <span class="style6">Dear <?php echo $_REQUEST['nam'];?>, congratulation, registration succesfully done!</span><br />
  <br />
  Thank you for registering with us, however your account is inactive at present. Kindly check your email with which you have registered with us for and confirmation email from us. Click on the link in the email to verify your account and start using it.<br /><br />thanks & regards,<br /><br />RIHF System Support
   <?php
   }
   elseif(isset($_REQUEST['msg']) && $_REQUEST['msg']==2)
   {
   ?>
   <span class="style6">Dear <?php echo $_REQUEST['nam'];?>, congratulation, Your account is now active!</span><br />
  <br />
  Thank you for verifying your account. you account is now active and you can start using it. <br /><br />Kindly go to the <a href="login.php"><span class="style6">LOGIN</span></a> page to sign into your account.<br /><br />thanks & regards,<br /><br />
  RIHF System Support
  <?php
  }
  elseif(isset($_REQUEST['msg']) && $_REQUEST['msg']==3)
   {
   ?>
   <span class="style6">Thank you for yousing your account.</span><br />
  <br />
  You have successfylly logged out of your account.
  <?php
  }
  elseif(isset($_REQUEST['msg']) && $_REQUEST['msg']==4)
   {
   ?>
   <span class="style6">Thank you for voulenteering at RIHF. We will contact you shortly.</span><br />
  <?php
  }
  ?></td>
          </tr>
