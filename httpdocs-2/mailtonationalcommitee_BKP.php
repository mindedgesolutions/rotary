...
function dispnationalcommitee(val)
{
if(val=='')
{
                        		...
                        		<td>
                                    ...
                                    <table width="40%" border="0" cellspacing="0" cellpadding="0" style="text-align:left; margin-bottom:10px">
									 <tr>
										...
										<td width="89%">
										<select id="choworkarea" name="choworkarea" class="button" onchange="dispnationalcommitee(this.value)" style="width:50%; cursor:pointer; color:#333333; font-weight:bold; padding:7px 0 7px 4px">
