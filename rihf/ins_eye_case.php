...
$query1="SELECT MAX(ref_no) as max_mark FROM `eye_case`"; 
...
mkdir("eye_ref/".$id, 0777);
mkdir("eye_ref/".$id."/other", 0777);
//----------------------------------------------------------------
...
//--------------------------------------------------------------------------------
$query="INSERT into eye_case (ref,name,ad1,ad2,city,age,sex,photo,prscription,c_report,p_report,ecg,scans,quotations,p_surgery,status,ref_no,date) VALUES ('$email','$name','$ad1','$ad2','$city',$age,'$sex','$file1','$file2','$file3','$file4','$file5','$file6','$file7','$ps','Submitted',$id,'$dt')";
$result=mysql_query($query);

$query="INSERT into case_eye_donations (ref_id) VALUES ($id)";
$result=mysql_query($query);

$query="INSERT into case_eye_ongoing (ref_id) VALUES ($id)";
$result=mysql_query($query);
