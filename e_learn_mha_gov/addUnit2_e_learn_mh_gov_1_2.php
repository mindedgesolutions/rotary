...
<![endif]-->
 <script>
  $(document).ready(function() {
    $("#txtDtOfInstallation").datepicker({ dateFormat: 'dd/mm/yy',
											changeMonth: true,
											changeYear: true,
											maxDate: 0,
...
function IsNumeric202(e) {
            var keyCode = e.which ? e.which : e.keyCode
            var ret = ((keyCode >= 48 && keyCode <= 57) || specialKeys.indexOf(keyCode) != -1);
			document.getElementById("error202").style.display = ret ? "none" : "inline";
			return ret;
		}			
...
function checkEmail1(str)
{
    var re = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
	var email = str;
    if(email!='' && !re.test(str))
    {
	alert("Please enter a valid email address");
	document.getElementById('txtRotaryContactPerEmail').value='';
	document.getElementById('txtRotaryContactPerEmail').focus();
	return false;
	}
}
...
<div id="sumitone">                                      
										<table class="table">
                                            ...
                                            <tbody>		
	<form class="form-horizontal" name="frm" id="frm" action="ins_school_survey_maharashtra_gov_unit2admin.php" method="POST" enctype="multipart/form-data">	
								<tr>
		...
		<tr style="display:none;">
			...
			<header>
								...
								<tr>												
									...
									<td class="col-md-8">
										<label class="radio-inline" for = "rotary"><input type = "radio" name = "areyoua" id = "rotary" value = "Rotary" onclick="showDistrict(this.value);" <?php if($rilm_identity=='Rotary'){echo $chk;} ?> />Rotary</label>
										<label class="radio-inline" for = "innerwheel"><input type = "radio" name = "areyoua" id = "innerwheel" value = "Inner Wheel" onclick="showDistrict(this.value);" <?php if($rilm_identity=='Inner Wheel'){echo $chk;} ?> />Inner Wheel</label>
									</td>	
								...
								<tr>
									...
									<td class="col-md-8">
										<select class="form-control" id="ddDistrict" name="ddDistrict" onchange='showClub(this.value)' required >
								...
								<tr>
									...
									<td class="col-md-8">
										<input type="text" id="txtDtOfInstallation" name="txtDtOfInstallation" class="form-control" onkeypress="return restrictCharacters(event);" required value="<?php echo $dt_installation; ?>"/>
									</td>
								</tr>
								<tr>
									<td class="col-md-4">Company/Make</td>
									<td class="col-md-8">
										<input type="text" id="txtCompanyMake" name="txtCompanyMake" class="form-control" maxlength="100" required value="<?php echo $company_make; ?>" >
									</td>
								</tr>
								<tr>
									<td class="col-md-4">TV Model</td>
									<td class="col-md-8">
										<input type="text" id="txtTVModel" name="txtTVModel" class="form-control" maxlength="100" required value="<?php echo $tv_model; ?>" >
									</td>
								</tr>
								<tr>
									<td class="col-md-4">Rotary contact person name</td>
									<td class="col-md-8">
										<input type="text" id="txtRotaryContactPerName" name="txtRotaryContactPerName" class="form-control" maxlength="100" required value="<?php echo $name; ?>" >
									</td>
								</tr>
								<tr>
									<td class="col-md-4">Rotary contact person mobile</td>
									<td class="col-md-8">
										<input type="text" id="txtRotaryContactPerMobNo" name="txtRotaryContactPerMobNo" class="form-control" maxlength="10" required onkeypress="return IsNumeric202(event);" ondrop="return false;" onpaste="return false;" value="<?php echo $mobile; ?>" />
								...
								<tr>
									...
									<td class="col-md-8">
										<input type="text" id="txtRotaryContactPerEmail" name="txtRotaryContactPerEmail" class="form-control" maxlength="100" onblur="checkEmail1(this.value)" required value="<?php echo $email; ?>" >
									</td>
								</tr>
									<?php } 
										}
								...
								<tr>
									<td class="col-md-4">Date of installation :</td>
									<td class="col-md-8">
										<input type="text" id="txtDtOfInstallation" name="txtDtOfInstallation" class="form-control" onkeypress="return restrictCharacters(event);" required />
									</td>
								</tr>
								<tr>
									<td class="col-md-4">Company/Make</td>
									<td class="col-md-8">
										<input type="text" id="txtCompanyMake" name="txtCompanyMake" class="form-control" maxlength="100" required >
									</td>
								</tr>
								<tr>
									<td class="col-md-4">TV Model</td>
									<td class="col-md-8">
										<input type="text" id="txtTVModel" name="txtTVModel" class="form-control" maxlength="100" required >
									</td>
								</tr>
								<tr>
									<td class="col-md-4">Rotary contact person name</td>
									<td class="col-md-8">
										<input type="text" id="txtRotaryContactPerName" name="txtRotaryContactPerName" class="form-control" maxlength="100" required >
									</td>
								</tr>
								<tr>
									<td class="col-md-4">Rotary contact person mobile</td>
									<td class="col-md-8">
										<input type="text" id="txtRotaryContactPerMobNo" name="txtRotaryContactPerMobNo" class="form-control" maxlength="10" required onkeypress="return IsNumeric202(event);" ondrop="return false;" onpaste="return false;" />
														<span id="error202" style="color: Red; display: none">* Input digits (0 - 9)</span>	
									</td>
								</tr>
								<tr>
									<td class="col-md-4">Rotary contact person email id</td>
									<td class="col-md-8">
										<input type="text" id="txtRotaryContactPerEmail" name="txtRotaryContactPerEmail" class="form-control" maxlength="100" onblur="checkEmail1(this.value)" required  >
									</td>
								</tr>
									<?php } ?>
								<tr>
