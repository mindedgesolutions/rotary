...
$query2=mysql_query("SELECT * from rihf_content where text_heading='polio' limit 0,1");
	...
	<?php       
	 ...
	 ?>
        ...
        <td align="left" valign="top" class="text"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" valign="top"><span class="heading1">POLIO</span> <span class="heading2">ERADICATION</span><br /><br />
			<table width="692" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?php echo $rec2['text_dscription'];?><br />&nbsp;</td>
  </tr>
  <tr>
    <td><img src="uploads/content/<?php echo $rec2['text_details'];?>" width="704" height="217" /><br />&nbsp;</td>
  </tr>
</table>
</td>
          </tr>
